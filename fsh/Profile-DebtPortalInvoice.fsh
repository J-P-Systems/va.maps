...
* recipient and totalNet and totalPriceComponent[va-prev-bal].amount and totalPriceComponent[va-prev-bal].type and totalPriceComponent[va-prev-bal].code.text and totalPriceComponent[va-total-charges].amount and totalPriceComponent[va-total-charges].type and totalPriceComponent[va-total-charges].code.text and totalPriceComponent[va-total-credits].amount and totalPriceComponent[va-total-credits].type and totalPriceComponent[va-total-credits].code.text and totalPriceComponent[va-new-balance].amount and totalPriceComponent[va-new-balance].type and totalPriceComponent[va-new-balance].code.text and lineItem.chargeItemReference and lineItem.priceComponent.amount and lineItem.priceComponent.type and lineItem.priceComponent.code.text and status and totalPriceComponent[va-admin-cost-bal].amount and totalPriceComponent[va-admin-cost-bal].type and totalPriceComponent[va-admin-cost-bal].code.text and totalPriceComponent[va-marsh-fee].amount and totalPriceComponent[va-marsh-fee].type and totalPriceComponent[va-marsh-fee].code.text and totalPriceComponent[va-court-cost].amount and totalPriceComponent[va-court-cost].type and totalPriceComponent[va-court-cost].code.text and totalPriceComponent[va-principal-paid].amount and totalPriceComponent[va-principal-paid].type and totalPriceComponent[va-principal-paid].code.text and totalPriceComponent[va-interest-paid].amount and totalPriceComponent[va-interest-paid].type and totalPriceComponent[va-interest-paid].code.text and totalPriceComponent[va-admin-cost-paid].amount and totalPriceComponent[va-admin-cost-paid].type and totalPriceComponent[va-admin-cost-paid].code.text and totalPriceComponent[va-marsh-fee-paid].amount and totalPriceComponent[va-marsh-fee-paid].type and totalPriceComponent[va-marsh-fee-paid].code.text and totalPriceComponent[va-court-cost-paid].amount and totalPriceComponent[va-court-cost-paid].type and totalPriceComponent[va-court-cost-paid].code.text MS
...
* id -> "1975: target not supported case .01==.11"
...
* id -> "IB.AccountsReceivable.BillNumber,IB.AccountsReceivableTCSP.BillNumber\nIB.IBAction.ARBillNumber"