...
* ^status = #draft
* recipient and totalNet and totalPriceComponent.amount and lineItem.chargeItemReference and lineItem.priceComponent.amount and note and paymentTerms MS
...
* paymentTerms -> "1842: source value from AR CCPC STATEMENTS - SPECIAL NOTICES (349.2-40)" "This might need to be an extension so the mapping is symantically correct"
