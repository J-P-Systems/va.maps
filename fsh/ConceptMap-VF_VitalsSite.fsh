Instance: CMVFVitalsSite
InstanceOf: ConceptMap
Usage: #definition
* url = "http://va.gov/fhir/ConceptMap/CMVFVitalsSite"
* name = "VF_VitalsSite"
* title = "VF_VitalsSite"
* status = #active
* experimental = true
* description = "Terminology Maps VF_VitalsSite"
* sourceCanonical = "http://va.gov/fhir/ValueSet/VSVFVitalsSite"
* group[0].source = "http://va.gov/terminology/vistaDefinedElements/120.5-5"
* group[=].target = "http://snomed.info/sct"
* group[=].element[0].code = #4711291
