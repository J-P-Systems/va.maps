...
* ^status = #draft
* code.coding and code.coding.system and code.coding.code and code.coding.display and effectiveDateTime and note and performer and specimen and referenceRange.high and referenceRange.low and identifier.value and identifier.system and interpretation and issued and status and valueQuantity.value and valueQuantity.unit and subject and category MS
