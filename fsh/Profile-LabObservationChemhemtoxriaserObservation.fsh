...
* ^status = #draft
* effectiveDateTime and note and performer and referenceRange.high and identifier.value and identifier.system and interpretation and code.coding and code.coding.system and code.coding.code and code.coding.display and referenceRange.low and valueQuantity.value and issued and status and valueQuantity.unit and specimen and category and subject MS
