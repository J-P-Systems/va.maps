...
* conclusion and identifier.value and identifier.system and basedOn and status and effectiveDateTime and issued and performer[va-by] and performer[va-at] and category[LaboratorySlice] and category.text and code.coding and code.coding.code and code.coding.system and code.coding.display and code.text and subject and result MS
* identifier.system = "http://va.gov/fhir/identifiers/Sta3n$stationNr/63.5"
...
* identifier.system -> "1605-1: fixed value = http://va.gov/fhir/identifiers/Sta3n$stationNr/63.5" "from mapParameter 1"
