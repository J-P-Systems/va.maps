Profile: VitalSignsCPMObservation
...
* extension[http://hl7.org/fhir/StructureDefinition/observation-bodyPosition].valueCodeableConcept and issued and performer and status and effectiveDateTime and category and subject and identifier.value and identifier.system and code.coding and method and valueQuantity.value and valueQuantity.code and component[va-pre-condition].valueCodeableConcept.coding and component[va-pre-condition].code and component[va-pre-condition-device].valueCodeableConcept.coding and component[va-pre-condition-device].code and component[va-cuff-size].valueCodeableConcept.coding and component[va-cuff-size].code MS
...
Mapping: vista-to-VitalSignsCPMObservation
Id: vista
Title: "Veterans Health Information Systems Technology and Architecture (VistA)"
Source: VitalSignsCPMObservation
* extension[http://hl7.org/fhir/StructureDefinition/observation-bodyPosition].valueCodeableConcept -> "866: terminologyMaps using VF_VitalsBodyPosition on GMRV VITAL MEASUREMENT - QUALIFIER > GMRV VITAL QUALIFIER - VUID (120.5-5 > 120.52-99.99)" "Not part of US core. Will need to handle the different program uses."
