...
* extension[http://hl7.org/fhir/StructureDefinition/observation-bodyPosition].valueCodeableConcept and issued and performer and status and effectiveDateTime and category and subject and identifier.value and code.coding and method and valueQuantity.value and valueQuantity.code and component[va-pre-condition].valueCodeableConcept.coding and component[va-pre-condition-device].valueCodeableConcept.coding and component[va-cuff-size].valueCodeableConcept.coding MS
