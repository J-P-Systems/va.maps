...
* address[va-physical].line -> "1258: source value from INSTITUTION - STREET ADDR. 1 (4-1.01)"
* address[va-physical].line -> "1259: source value from INSTITUTION - STREET ADDR. 2 (4-1.02)"
* address[va-physical].city -> "1260: source value from INSTITUTION - CITY (4-1.03)"
* address[va-physical].district -> "1261: source value from INSTITUTION - DISTRICT (4-.03)"
* address[va-physical].state -> "1262: source value from INSTITUTION - STATE > STATE - ABBREVIATION (4-.02 > 5-1)"
* address[va-physical].postalCode -> "1263: source value from INSTITUTION - ZIP (4-1.04)"
...
* address[va-postal].city -> "1271: source value from INSTITUTION - CITY (MAILING) (4-4.03)"
* address[va-postal].state -> "1272: source value from INSTITUTION - STATE (MAILING) (4-4.04)"
* address[va-postal].postalCode -> "1273: source value from INSTITUTION - ZIP (MAILING) (4-4.05)"
* address[va-postal].country -> "1274: source value from INSTITUTION - COUNTRY > COUNTRY CODE - CODE (4-801 > 779.004-.01)" "Assume country is same as for physical\nOrganization.address.where(type=\"postal\")"
