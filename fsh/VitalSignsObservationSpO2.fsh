...
* component.valueQuantity.value -> "1239: transform using Split_SpO2_value.Flow on GMRV VITAL MEASUREMENT - SUPPLEMENTAL O2 (#120.5-1.4) case VUID = 4500637" "Value needs to be parsed from VistA"
* component.valueQuantity.value -> "1240: transform using Split_SpO2_value.Consentraion on GMRV VITAL MEASUREMENT - SUPPLEMENTAL O2 (#120.5-1.4) case VUID = 4500637" "Value needs to be parsed from VistA"
