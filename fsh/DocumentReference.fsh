...
* ^status = #draft
* masterIdentifier and identifier and type and category and subject and date and author and authenticator and custodian and description and securityLabel and content.id and content.attachment.id and content.attachment.contentType and content.attachment.language and content.attachment.data and content.attachment.url and content.attachment.size and content.attachment.hash and content.attachment.title and content.attachment.creation and content.format and context.id and context.encounter and context.event and context.period.start and context.period.end and context.facilityType and context.practiceSetting and context.sourcePatientInfo and context.related MS
...
* content.attachment.url -> "892: transform using null on TIU DOCUMENT - REPORT TEXT (#8925-2)" "option 2: tbd\nUS Core: DocumentReference.content.attachment.url or DocumentReference.content.attachment.data or both SHALL be present."
...
Source: DocumentReference
* content.attachment.url -> "#ERROR_#REF!"
