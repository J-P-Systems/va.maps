...
Description: "This StructureDefinition contains the maps for VistA TIU DOCUMENT (file 8925) to FHIR DocumentReference"
* ^status = #draft
...
* type -> "874: source value from TIU DOCUMENT - DOCUMENT TYPE > TIU DOCUMENT DEFINITION - VHA ENTERPRISE STANDARD TITLE (#8925-.01 > 8925.1-1501)" "Get LOINC from VistA or use TIU_VHA_ENTERPRISE_STANDARD_TITLE_8926.1 file provided by KBS to look up LOINC mapping\nCDW now has a view."
* category -> "875: transform using TIU_VHA_ENTERPRISE_STANDARD_TITLE_8926.1 on TIU DOCUMENT - DOCUMENT TYPE > TIU VHA ENTERPRISE STANDARD TITLE - DOCUMENT TYPE (#8925-.01 > 8926.1-.08)" "(= NOTE, ADDENDUM, CONSULT, etc.?)\nUse TIU_VHA_ENTERPRISE_STANDARD_TITLE_8926.1 file provided by KBS to look up DocType"
...
Source: DocumentReference
* category -> "Dim.TIUStandardTitle.TIUDocumentTypeIEN"
