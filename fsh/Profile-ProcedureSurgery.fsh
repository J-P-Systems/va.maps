...
* performer[va-0].actor -> "1298: reference from SURGERY - PERFUSIONIST (130-.167)" "/Practitioner|Role"
...
* performer[va-1].actor -> "1330: reference from SURGERY - PRIMARY SURGEON (130-.14)" "/Practitioner|Role"
...
* performer[va-2].actor -> "1331: reference from SURGERY - FIRST ASST (130-.15)" "/Practitioner|Role"
...
* performer[va-3].actor -> "1332: reference from SURGERY - SECOND ASST (130-.16)" "/Practitioner|Role"
...
* performer[va-4].actor -> "1333: reference from SURGERY - ATTENDING SURGEON (130-.164)" "/Practitioner|Role"
...
* performer[va-5].actor -> "1334: reference from SURGERY - ASST PERFUSIONIST (130-.168)" "/Practitioner|Role"
...
* performer[va-6].actor -> "1335: reference from SURGERY - SKIN PREPPED BY (1) (130-.18)" "/Practitioner|Role"
...
* performer[va-7].actor -> "1336: reference from SURGERY - PRINC ANESTHETIST (130-.31)" "/Practitioner|Role"
...
* performer[va-8].actor -> "1337: reference from SURGERY - RELIEF ANESTHETIST (130-.32)" "/Practitioner|Role"
...
* performer[va-9].actor -> "1338: reference from SURGERY - ASST ANESTHETIST (130-.33)" "/Practitioner|Role"
...
* performer[va-10].actor -> "null: reference from SURGERY - ANESTHESIOLOGIST SUPVR (130-.34)" "/Practitioner|Role"
* performer[va-10].function.text -> "null-1: fixed value = ANESTHESIOLOGIST SUPVR" "from mapParameter 1"
* performer[va-10].function.coding -> "null-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/130#.34 ANESTHESIOLOGIST SUPVR" "from mapParameter 2"
* performer[va-11].actor -> "1340: reference from SURGERY - VERIFIER (130-.522)" "/Practitioner|Role"
...
* performer[va-12].actor -> "1341: reference from SURGERY - PROVIDER (130-123)" "/Practitioner|Role"
...
* performer[va-13].actor -> "1342: reference from SURGERY - FOLEY CATHETER INSERTED BY (130-.57)" "/Practitioner|Role"
