...
* vaccineCode -> "1893: source value from ADERS - Vac3_TypeBrand (A-17.31)"
* manufacturer.display -> "1894: source value from ADERS - Vac3_Mfgr (A-17.32)"
* lotNumber -> "1895: source value from ADERS - Vac3_Lot (A-17.33)"
* route -> "1896: source value from ADERS - Vac3_Route (A-17.34)"
* site -> "1897: source value from ADERS - Vac3_Site (A-17.35)"
* protocolApplied.doseNumberString -> "1898: source value from ADERS - Vac3_DoseInSeries (A-17.36)"
