...
* identifier.system = "http://va.gov/fhir/identifiers/Sta3n$stationNr/74"
...
* identifier.system -> "1619-1: fixed value = http://va.gov/fhir/identifiers/Sta3n$stationNr/74" "from mapParameter 1"
