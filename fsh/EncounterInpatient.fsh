...
* ^status = #draft
* identifier.value and class and status and subject and participant.individual and period.start and period.end and reasonCode and hospitalization.admitSource.coding.code and hospitalization.admitSource.coding and hospitalization.origin.display and hospitalization.destination.display and hospitalization.dischargeDisposition and location.location and serviceProvider and type MS
...
Mapping: vista-to-EncounterInpatient
Id: vista
Title: "Veterans Health Information Systems Technology and Architecture (VistA)"
Source: EncounterInpatient
...
* hospitalization.admitSource.coding.code -> "453: source value from PTF - SOURCE OF ADMISSION > SOURCE OF ADMISSION - PTF CODE (#45-20 > 45.1-.01)" "MvdZ QA"
...
Mapping: cdw-to-EncounterInpatient
Id: cdw
