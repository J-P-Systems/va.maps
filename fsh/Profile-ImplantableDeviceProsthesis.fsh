...
* ^status = #draft
* identifier.value and manufacturer and expirationDate and lotNumber and serialNumber and deviceName.name and modelNumber and type and patient and owner MS
