...
* identifier.value and identifier.system and clinicalStatus and code.coding[va-icd] and code.coding[va-icd].system and code.coding[va-icd].code and code.coding.code and code.coding.system and subject and onsetDateTime and recordedDate and recorder and verificationStatus and code.text and category[us-core] and abatementDateTime MS
