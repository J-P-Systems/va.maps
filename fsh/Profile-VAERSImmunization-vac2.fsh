...
* vaccineCode -> "1887: source value from ADERS - 17_Vac2_TypeBrand (A-17.21)"
* manufacturer.display -> "1888: source value from ADERS - 17_Vac2_Mfgr (A-17.22)"
* lotNumber -> "1889: source value from ADERS - 17_Vac2_Lot (A-17.23)"
* route -> "1890: source value from ADERS - 17_Vac2_Route (A-17.24)"
* site -> "1891: source value from ADERS - 17_Vac2_Site (A-17.25)"
* protocolApplied.doseNumberString -> "1892: source value from ADERS - 17_Vac2_DoseInSeries (A-17.26)"
