Profile: LabObservationMicrobiologyMycology
Parent: http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-lab
Id: LabObservationMicrobiologyMycology
Title: "Lab Observation: Microbiology Mycology"
Description: "This StructureDefinition contains the maps for VistA file MICROBIOLOGY (63.05) to us-core-observation-lab"
* ^status = #draft
* code and status MS
* status from http://va.gov/fhir/ValueSet/VSVFLabObservationStatus

Mapping: vista-to-LabObservationMicrobiologyMycology
Id: vista
Title: "Veterans Health Information Systems Technology and Architecture (VistA)"
Source: LabObservationMicrobiologyMycology
...
Mapping: cdw-to-LabObservationMicrobiologyMycology
Id: cdw
