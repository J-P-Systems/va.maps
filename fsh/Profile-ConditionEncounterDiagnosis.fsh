...
* ^status = #draft
* identifier.value and identifier.system and encounter and onsetDateTime and recordedDate and clinicalStatus and verificationStatus and category[us-core] and subject and code and code.coding.system and code.coding.code and recorder MS
