...
* ^status = #draft
* subject and category[us-core] and identifier.value and identifier.system and code and code.coding.system and code.coding.code and encounter and onsetDateTime and recordedDate and clinicalStatus and verificationStatus and recorder MS
