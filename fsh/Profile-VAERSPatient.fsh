...
* name -> "null: target not supported" "because of must-support"
* telecom -> "null: target not supported" "because of must-support"
* address -> "null: target not supported" "because of must-support"
* communication.language -> "null: target not supported" "because of must-support"
