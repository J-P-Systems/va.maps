...
* telecom[va-data-pager].value -> "390: source value from NEW PERSON - DIGITAL PAGER (200-.138)" "Change from Practitioner to PractitionerRole (use case and FHIR Path) to support US Core"
* telecom[va-data-pager].system -> "390-1: fixed value = #pager" "from mapParameter 1"
* telecom[va-mail].value -> "391: source value from NEW PERSON - EMAIL ADDRESS (200-.151)" "Change from Practitioner to PractitionerRole (use case and FHIR Path) to support US Core"
* telecom[va-mail].system -> "391-1: fixed value = #email" "from mapParameter 1"
...
* specialty.coding.code -> "419: source value from NEW PERSON - PERSON CLASS > PERSON CLASS - X12 CODE (200-8932.1 > 200.05-.01 > 8932.1-6)" "Added paths"
