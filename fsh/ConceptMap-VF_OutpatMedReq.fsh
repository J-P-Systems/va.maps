Instance: CMVFOutpatMedReq
InstanceOf: ConceptMap
Usage: #definition
* url = "http://va.gov/fhir/ConceptMap/CMVFOutpatMedReq"
* name = "VF_OutpatMedReq"
* title = "VF_OutpatMedReq"
* status = #active
* experimental = true
* description = "Terminology Maps VF_OutpatMedReq"
* sourceCanonical = "http://va.gov/fhir/ValueSet/VSVFOutpatMedReq"
