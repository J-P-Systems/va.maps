...
* identifier.system = "http://va.gov/fhir/identifiers/Sta3n$stationNr/63.04"
...
* identifier.system -> "851-1: fixed value = http://va.gov/fhir/identifiers/Sta3n$stationNr/63.04" "from mapParameter 1"
