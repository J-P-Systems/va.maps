...
* ^status = #draft
* code.coding and code.coding.system and code.coding.code and code.coding.display and status and performer.actor and statusReason.text and encounter and subject and category.text and performedDateTime and location MS
