...
* extension[http://hl7.org/fhir/5.0/StructureDefinition/extension-DiagnosticReport.note].valueAnnotation and status and effectiveDateTime and issued and performer[va-by] and identifier.value and identifier.system and performer[va-at] and basedOn and category[LaboratorySlice] and code.coding and code.coding.code and code.coding.system and code.coding.display and subject and result and code.text and category.text MS
...
* extension[http://hl7.org/fhir/5.0/StructureDefinition/extension-DiagnosticReport.note].valueAnnotation -> "1443: source value from MICROBIOLOGY - PARASITE RPT REMARK > PARASITE RPT REMARK - PARASITE RPT REMARK (63.05-17 > 63.36-.01)" "This is the correct mapping, however, .note was not added to DR until FHIR R5. Keeping the mapping here for future"
