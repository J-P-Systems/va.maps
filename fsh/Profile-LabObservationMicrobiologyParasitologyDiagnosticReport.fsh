...
Source: LabObservationMicrobiologyParasitologyDiagnosticReport
* extension[http://va.gov/fhir/StructureDefinition/extension-DiagnosticReport-note].valueString -> "Micro.ParasitologyReports.ParasitologyReportRemark"
