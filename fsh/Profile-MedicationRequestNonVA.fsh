...
* identifier.value -> "1762: source value from NON-VA MEDS - ORDER NUMBER (55.05-7)" "Not required by US Core"
* identifier.system -> "1762-1: fixed value = http://va.gov/identifiers/$Sta3n/55.05-7" "from mapParameter 1"
...
Source: MedicationRequestNonVA
* identifier.value -> "NonVAMed.NonVAMed.CPRSOrderIEN"
