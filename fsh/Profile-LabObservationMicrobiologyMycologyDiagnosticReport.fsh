...
* extension[http://va.gov/fhir/StructureDefinition/extension-DiagnosticReport-note].valueString -> "1444: source value from MICROBIOLOGY - MYCOLOGY RPT REMARK > MYCOLOGY RPT REMARK - MYCOLOGY RPT REMARK (63.05-21 > 63.38-.01)" "This is the correct mapping, however, .note was not added to DR until FHIR R5. Keeping the mapping here for future"
...
Source: LabObservationMicrobiologyMycologyDiagnosticReport
* extension[http://va.gov/fhir/StructureDefinition/extension-DiagnosticReport-note].valueString -> "Micro.MycologyReports.MycologyReportRemark"
