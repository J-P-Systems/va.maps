...
* ^status = #draft
* ^abstract = true
* identifier.value and basedOn and status and effectiveDateTime and issued and performer and category[LaboratorySlice] and category.text and code.coding and code.text and subject and result MS
