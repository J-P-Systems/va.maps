...
* address.district -> "1316: source value from HOSPITAL LOCATION - INSTITUTION > DISTRICT (44-3 > 4-.03)"
* address.line -> "1317: source value from HOSPITAL LOCATION - INSTITUTION > STREET ADDR. 1 (44-3 > 4-1.01)"
* address.line -> "1318: source value from HOSPITAL LOCATION - INSTITUTION > STREET ADDR. 2 (44-3 > 4-1.02)"
