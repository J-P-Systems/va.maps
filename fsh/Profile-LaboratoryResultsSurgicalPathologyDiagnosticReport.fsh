...
* identifier.system = "http://va.gov/fhir/identifiers/Sta3n$stationNr/63.53"
...
* identifier.system -> "1606-1: fixed value = http://va.gov/fhir/identifiers/Sta3n$stationNr/63.53" "from mapParameter 1"
