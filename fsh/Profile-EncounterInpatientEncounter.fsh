...
* identifier[va-IEN].value and identifier[va-IEN].system and identifier[va-IEN].type.text and identifier[va-IA].value and identifier[va-IA].system and identifier[va-IA].type.text and status and subject and participant.individual and participant.type.coding and period.start and period.end and reasonCode[va-principle].coding.code and reasonCode[va-principle].coding.system and reasonCode[va-secondary].coding.code and reasonCode[va-secondary].coding.system and reasonCode[va-procedure].coding.code and reasonCode[va-procedure].coding.system and hospitalization.admitSource.coding.code and hospitalization.admitSource.coding.system and hospitalization.origin.display and hospitalization.destination.display and hospitalization.dischargeDisposition.coding.code and hospitalization.dischargeDisposition.coding.system and location.location and hospitalization.admitSource.coding and serviceProvider and class and type and type.coding.system and type.coding.code and type.coding.display and type.text and diagnosis.condition and diagnosis.rank MS
...
* reasonCode[va-secondary].coding.code -> "449: source value from PTF - SECONDARY DIAGNOSIS 1-24 > ICD DIAGNOSIS - CODE NUMBER (45-79.* > 80-.01)" "*) 79.16-79.19,79.201,79.21-79.24,79.241-79.249,79.2491,79.24911-79.24915"
* reasonCode[va-secondary].coding.system -> "449-1: fixed value = urn:see-termmap-in-mapParameter" "from mapParameter 1"
* reasonCode[va-procedure].coding.code -> "450: source value from PTF - PROCEDURE 1-5 > ICD OPERATION/PROCEDURE - CODE NUMBER (45-45.01+to+45.05 > 80.1-.01)" "45.01-45.05"
...
* diagnosis.rank -> "1723-1: fixed value = 1" "from mapParameter 1"
