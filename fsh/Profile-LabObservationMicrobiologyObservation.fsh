...
* ^status = #draft
* ^abstract = true
* effectiveDateTime and note and performer and identifier.value and identifier.system and code.coding and code.coding.system and code.coding.code and code.coding.display and issued and specimen and category and subject MS
