...
* ^status = #draft
* basedOn and category[LaboratorySlice] and code.coding and code.coding.code and code.coding.system and code.coding.display and subject and result and code.text and category.text MS
