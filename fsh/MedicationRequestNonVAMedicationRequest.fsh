...
Invariant: inv-18
Description: "1540: fixed value = plan when NON-VA MEDS - ORDER NUMBER (#55.05-7) case Not null"
Severity: #warning

Invariant: inv-19
Description: "1347: fixed value = true when NON-VA MEDS - ORDER NUMBER (#55.05-7) case Not null"
Severity: #warning
