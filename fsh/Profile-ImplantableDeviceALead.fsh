...
* identifier.system = "http://va.gov/fhir/identifiers/Sta3n$stationNr/698.2"
...
* identifier.system -> "1350-1: fixed value = http://va.gov/fhir/identifiers/Sta3n$stationNr/698.2" "from mapParameter 1"
