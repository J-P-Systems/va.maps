...
* vaccineCode -> "1941: source value from ADERS - PVac4_TypeBrand (A-22.41)"
* manufacturer.display -> "1942: source value from ADERS - PVac4_Mfgr (A-22.42)"
* lotNumber -> "1943: source value from ADERS - PVac4_Lot (A-22.43)"
* route -> "1944: source value from ADERS - PVac4_Route (A-22.44)"
* site -> "1945: source value from ADERS - PVac4_Site (A-22.45)"
* protocolApplied.doseNumberString -> "1946: source value from ADERS - PVac4_DoseInSeries (A-22.46)"
* occurrenceDateTime -> "1947: source value from ADERS - PVac4_Date (A-22.47)"
