...
* ^status = #draft
* status and vaccineCode and vaccineCode.text and patient and occurrenceDateTime and lotNumber and manufacturer and doseQuantity.value and performer.actor and performer.function and note.text and protocolApplied.doseNumberString and doseQuantity and doseQuantity.unit and doseQuantity.code and statusReason and primarySource and recorded and vaccineCode.coding.code and vaccineCode.coding.system and reaction.detail and encounter and location MS
