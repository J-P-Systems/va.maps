Profile: EncounterOutpatientVisit
Parent: http://hl7.org/fhir/us/core/StructureDefinition/us-core-encounter
Id: EncounterOutpatientVisit
Title: "Encounter: Outpatient (Visit)"
Description: "This StructureDefinition contains the maps for VistA VISIT (file 9000010) to FHIR Encounter"
* ^status = #draft
* serviceProvider only Reference(http://hl7.org/fhir/us/core/StructureDefinition/us-core-organization)

Mapping: vista-to-EncounterOutpatientVisit
Id: vista
Title: "Veterans Health Information Systems Technology and Architecture (VistA)"
Source: EncounterOutpatientVisit
