...
* vaccineCode -> "528: terminologyMaps using VF_inferredCVX on V IMMUNIZATION - IMMUNIZATION > IMMUNIZATION - NAME (#9000010.11-.01 > 9999999.14-.01) case V IMMUNIZATION - IMMUNIZATION null"
...
* reaction.detail -> "++: reference from V IMMUNIZATION - REACTION (#9000010.11-.06)"
