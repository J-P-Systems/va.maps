...
* sourceCanonical = "http://va.gov/fhir/ValueSet/VSVFVitalsPosition-vista"
* targetCanonical = "http://va.gov/fhir/ValueSet/VSVFVitalsPosition"
...
Title: "VF_VitalsPosition"
Description: "FHIR Target ValueSet for Terminology Maps VF_VitalsPosition"
* ^experimental = false
* ^name = "VF_VitalsPosition"
...
ValueSet: VSVFVitalsPosition-vista
Title: "VF_VitalsPosition VistA"
Description: "VistA Source ValueSet for Terminology Maps VF_VitalsPosition"
* ^experimental = false
* ^name = "VF_VitalsPosition"
