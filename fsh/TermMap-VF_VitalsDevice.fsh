...
* group[=].element[=].target.display = "Controlled ventilation (procedure)"
* group[=].element[=].target.equivalence = #equal
...
* group[=].element[=].target.display = "Child (person)"
* group[=].element[=].target.equivalence = #equal
...
* group[=].element[=].target.display = "Procedure on thigh (procedure)"
* group[=].element[=].target.equivalence = #equal
...
* group[=].element[=].target.display = "Artificial respiration (procedure)"
* group[=].element[=].target.equivalence = #equal
