...
* group[=].element[=].target.comment = "From 63-7 DISPOSITION"
...
* ^experimental = false
* ^name = "VF_DiagnosticReportLabStatus"
* include http://terminology.hl7.org/ValueSet/v2-0123#C "CORRECTED RESULTS"
* include http://terminology.hl7.org/ValueSet/v2-0123#F "FINAL RESULTS"
* include http://terminology.hl7.org/ValueSet/v2-0123#Y "NO ORDER ON RECORD"
* include http://terminology.hl7.org/ValueSet/v2-0123#R "NOT VERIFIED"
* include http://terminology.hl7.org/ValueSet/v2-0123#X "ORDER CANCELED"
* include http://terminology.hl7.org/ValueSet/v2-0123#O "ORDER RECIEVED"
* include http://terminology.hl7.org/ValueSet/v2-0123#P "PRELIMINARY"
* include http://terminology.hl7.org/ValueSet/v2-0123#S "PROCEDURE SCHEDULED"
* include http://terminology.hl7.org/ValueSet/v2-0123#A "SOME RESULTS AVAILABLE"
* include http://terminology.hl7.org/ValueSet/v2-0123#I "SPECIMEN RECEIVED"