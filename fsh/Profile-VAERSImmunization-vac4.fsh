...
* vaccineCode -> "1899: source value from ADERS - 17_Vac4_TypeBrand (A-17.41)"
* manufacturer.display -> "1900: source value from ADERS - 17_Vac4_Mfgr (A-17.42)"
* lotNumber -> "1901: source value from ADERS - 17_Vac4_Lot (A-17.43)"
* route -> "1902: source value from ADERS - 17_Vac4_Route (A-17.44)"
* site -> "1903: source value from ADERS - 17_Vac4_Site (A-17.45)"
* protocolApplied.doseNumberString -> "1904: source value from ADERS - 17_Vac4_DoseInSeries (A-17.46)"
