...
* identifier[va-IEN].value and identifier[va-IEN].system and code.text and code and patient and recorder and reaction.manifestation and reaction.manifestation.coding.system and reaction.manifestation.coding.code and reaction.manifestation.coding.display and reaction.manifestation.text and type and verificationStatus and clinicalStatus and category and reaction.severity and recordedDate and note.time and note.authorString and note.text and identifier[va-CDW].value and identifier[va-CDW].system and reaction.onset MS
...
* id -> "1974: target not supported" "Just here to link 120.85 to 120.8"
