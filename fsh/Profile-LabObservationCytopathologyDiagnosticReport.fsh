...
* code.coding.code and code.coding.system and identifier.value and identifier.system and basedOn and code.text and code and status and effectiveDateTime and issued and performer[va-by] and performer[va-at] and resultsInterpreter and specimen and media.link and conclusion and presentedForm.data and subject and category[LaboratorySlice] and category.text and code.coding and code.coding.display and result MS
