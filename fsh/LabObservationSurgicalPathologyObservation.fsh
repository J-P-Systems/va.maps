...
Description: "This StructureDefinition contains the maps for VistA file SURGICAL PATHOLOGY (#63.08) to us-core-observation-lab"
* ^status = #draft
...
* specimen -> "1660: reference from SURGICAL PATHOLOGY - SURGICAL PATH ACC # (#63.08-.06)"
