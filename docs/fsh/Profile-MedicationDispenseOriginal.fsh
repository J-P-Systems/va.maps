...
Description: "52-31: if not null then #completed"
Severity: #warning
...
* medicationCodeableConcept.coding.code -> "Medication.DrugProduct,Medication.CMOP\nMedication.DrugProduct.Identifier2,Medication.DrugProduct.ProductName,Medication.DrugProductExtension.FederalSchedule"
* medicationCodeableConcept.text -> "Medication.DrugProduct,Medication.CMOP\nMedication.DrugProduct.Description,Medication.DrugProduct.OriginalText,Medication.DrugProduct.Description,Medication.DrugProduct.OriginalText,Medication.ATCCode.Code,Medication.Generic.Description,Medication.Route.Description,Medication.OrderCategory.Description,Medication.OriginalText,Medication.OriginalText"
