...
Description: "360-1.02 > 399-304>399.0304-20>409.68-.05: if Outpatient then /EncounterOutpatient"
Severity: #warning

Invariant: dpci-27-2009
Description: "360-1.02 > 399-.08: if Inpatient then /EncounterInpatientEncounter"
Severity: #warning
...
* subject -> "1839: reference from INTEGRATED BILLING ACTION - PATIENT > PATIENT (350-.02 > 2-)"
