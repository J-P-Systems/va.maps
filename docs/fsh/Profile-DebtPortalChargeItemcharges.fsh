...
* identifier contains va-billno 0..1 and va-artransno 0..1
...
* enteredDate and code.text and identifier[va-billno] and status and subject and identifier[va-artransno] and context and occurrencePeriod.start and occurrencePeriod.end and service[va-rxorig] and service[va-rxrefill] and service[va-rxpartial] MS
...
* status = #billed
* identifier[va-artransno] obeys dpci-27-2218
...
Description: "If 360-1.04 == 350 && Inpatient then reference /EncounterInpatientEncounter based on (360-1.02 > 399-.08)"
Severity: #warning
Expression: "true"

Invariant: dpci-27-2010
Description: "If 52-106 == 350 then reference /MedicationDispenseOriginal based on (52-)"
Severity: #warning
Expression: "true"

Invariant: dpci-27-2011
Description: "If 52-106 == 350 then reference /MedicationDispenseRefill based on (52-)"
Severity: #warning
Expression: "true"

Invariant: dpci-27-2012
Description: "If 52-106 == 350 then reference /MedicationDispensePartial based on (52-)"
Severity: #warning
Expression: "true"
