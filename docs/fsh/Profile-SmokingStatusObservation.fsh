...
* identifier.system -> "1241-1: fixed value = http://va.gov/identifiers/$Sta3n/9000010.23" "generated from mapParameter row 1"
...
* valueCodeableConcept.text -> "1249-1: source value" "generated from mapParameter row 1"
