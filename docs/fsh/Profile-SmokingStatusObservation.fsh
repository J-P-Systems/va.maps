...
* identifier.system -> "1241-1: fixed value = http://va.gov/identifiers/$Sta3n/9000010.23" "mapParameter row 1"
...
* valueCodeableConcept.text -> "1249-1: source value" "mapParameter row 1"
