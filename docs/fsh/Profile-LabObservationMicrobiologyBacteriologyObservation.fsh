...
* component[va-component].code.coding.code -> "1522-1: fixed value" "mapParameter row 1"
* component[va-component].code.coding.system -> "1522-2: fixed value = http://loinc.org" "mapParameter row 2"
