...
* identifier.system -> "345-1: fixed value = http://va.gov/identifiers/$Sta3n/9000011" "generated from mapParameter row 1"
...
* code.coding[va-icd].system -> "365-1: fixed value = urn:see-termmap-in-mapParameter" "generated from mapParameter row 1"
* code.coding[va-icd].code -> "365-2: source value based on PROBLEM - DIAGNOSIS > ICD DIAGNOSIS - CODE NUMBER (9000011-.01 > 80-.01)" "generated from mapParameter row 2"
* code.coding.code -> "366: source value based on PROBLEM - SNOMED CT CONCEPT CODE (9000011-80001)"
* code.coding.system -> "366-1: fixed value = http://snomed.info/sct" "generated from mapParameter row 1"
