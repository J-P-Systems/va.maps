...
* vaccineCode -> "1941: source value based on ADERS - 22_PVac4_TypeBrand"
* manufacturer.display -> "1942: source value based on ADERS - 22_PVac4_Mfgr"
* lotNumber -> "1943: source value based on ADERS - 22_PVac4_Lot"
* route -> "1944: source value based on ADERS - 22_PVac4_Route"
* site -> "1945: source value based on ADERS - 22_PVac4_Site"
* protocolApplied.doseNumberString -> "1946: source value based on ADERS - 22_PVac4_DoseInSeries"
* occurrenceDateTime -> "1947: source value based on ADERS - 22_PVac4_Date"
