...
* valueQuantity -> "2117: target not supported" "auto added because of must-support"
* valueCodeableConcept -> "2118: target not supported" "auto added because of must-support"
