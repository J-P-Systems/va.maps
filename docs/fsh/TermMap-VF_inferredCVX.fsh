...
* group[=].element[=].target.code = #109
* group[=].element[=].target.equivalence = #equal
* group[=].element[+].code = #PNEUMOVAX_ALLERGY__HISTORICAL_
* group[=].element[=].display = "PNEUMOVAX-ALLERGY (HISTORICAL)"
* group[=].element[=].target.code = #109
* group[=].element[=].target.equivalence = #equal
...
* include http://va.gov/terminology/vistaDefinedTerms/9999999.14-.01#PNEUMOVAX_ALLERGY__HISTORICAL_ "PNEUMOVAX-ALLERGY (HISTORICAL)"
