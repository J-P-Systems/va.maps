Instance: VF-inferredCVX
InstanceOf: ConceptMap
Usage: #definition
* url = "http://va.gov/fhir/ConceptMap/VF-inferredCVX"
* name = "VF_inferredCVX"
...
* include http://va.gov/terminology/vistaDefinedTerms/50.65-.02#PNEUMOVAX_ALLERGY__HISTORICAL_ "PNEUMOVAX-ALLERGY (HISTORICAL)"
