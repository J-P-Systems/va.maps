...
* result only Reference(LabObservationMicrobiologyMycologyObservation)
...
Mapping: source-to-LabObservationMicrobiologyMycologyDiagnosticReport
Id: vista
Title: "Veterans Health Information Systems Technology and Architecture (VistA)"
Source: LabObservationMicrobiologyMycologyDiagnosticReport
* extension[http://hl7.org/fhir/5.0/StructureDefinition/extension-DiagnosticReport.note].valueAnnotation -> "1444: source value based on MICROBIOLOGY - MYCOLOGY RPT REMARK > MYCOLOGY RPT REMARK - MYCOLOGY RPT REMARK (63.05-21 > 63.38-.01)" "This is the correct mapping, however, .note was not added to DR until FHIR R5. Use pre-adopt extension."
* identifier.value -> "1605: source value based on MICROBIOLOGY - ORDERED TEST > ORDERED TEST - IEN (63.05-.35 > 63.5-.001)"
* identifier.system -> "1605-1: fixed value = http://va.gov/identifiers/$Sta3n/63.5" "generated from mapParameter row 1"
...
* code.coding.code -> "1420-1: source value based on LABORATORY TEST - NATIONAL VA LAB CODE > WKLD CODE - DEFAULT LOINC CODE > LAB LOINC - CODE (60-64 > 64-25 > 95.3-.01)" "generated from mapParameter row 1"
* code.coding.system -> "1420-2: fixed value = http://loinc.org" "generated from mapParameter row 2"
* code.coding.display -> "1420-3: source value based on LABORATORY TEST - NATIONAL VA LAB CODE > WKLD CODE - DEFAULT LOINC CODE > LAB LOINC - COMPONENT (60-64 > 64-25 > 95.3-1)" "generated from mapParameter row 3"
...
Source: LabObservationMicrobiologyMycologyDiagnosticReport
* extension[http://hl7.org/fhir/5.0/StructureDefinition/extension-DiagnosticReport.note].valueAnnotation -> "Micro.MycologyReports.MycologyReportRemark"
...
Mapping: sda-to-LabObservationMicrobiologyMycologyDiagnosticReport
Id: sda
