...
* identifier.system -> "429-1: fixed value = http://va.gov/identifiers/$Sta3n/9000010-15001" "generated from mapParameter row 1"
...
* serviceType.coding.system -> "439-1: fixed value = http://va.gov/terminology/VistADefinedTerms/9000010-.07" "generated from mapParameter row 1"
...
* reasonCode.coding.system -> "447-1: fixed value = urn:see-termmap-in-mapParameter" "generated from mapParameter row 1"
...
* type.coding.system -> "1615-1: fixed value = http://www.ama-assn.org/go/cpt" "generated from mapParameter row 1"
* type.coding.code -> "1615-2: source value based on V CPT - CPT > CPT - CPT CODE (9000010.18-.01 > 81-.01)" "generated from mapParameter row 2"
* type.coding.display -> "1615-3: source value based on V CPT - CPT > CPT - SHORT NAME (9000010.18-.01 > 81-2)" "generated from mapParameter row 3"
* type.text -> "1615-4: source value based on V CPT - CPT > CPT - SHORT NAME (9000010.18-.01 > 81-2)" "generated from mapParameter row 4"
