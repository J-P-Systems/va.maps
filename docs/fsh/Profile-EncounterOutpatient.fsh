...
Source: EncounterOutpatient
* identifier.value -> "Encounter.EncounterExtension.VisitID,Encounter.EncounterExtension.VisitID"
* status -> "Encounter.CareProvider.Description,Encounter.CareProvider.Name"
* status -> "Encounter.CareProvider.Description,Encounter.CareProvider.Name"
...
* period.start -> "Encounter.CareProvider.Description,Encounter.CareProvider.Name"
* period.end -> "Encounter.ToTime"
* reasonCode.coding.code -> "Diagnosis.Diagnosis,Diagnosis.CodeTableDetail.Diagnosis.Code"
* diagnosis.condition -> "Diagnosis.DiagnosisExtension.ProblemId"
* location[va-stop].location -> "Encounter.EncounterExtension.StopCode"
...
* type -> "Encounter.EncounterExtension.Cpt,Encounter.EncounterExtension.Cpt,Procedure.Procedure,Procedure.CodeTableDetail.Procedure.Code"
* type.coding.code -> "Encounter.EncounterExtension.Cpt,Encounter.EncounterExtension.Cpt,Procedure.Procedure,Procedure.CodeTableDetail.Procedure.Code"
* type.coding.display -> "Encounter.EncounterExtension.Cpt,Encounter.EncounterExtension.Cpt,Procedure.Procedure,Procedure.CodeTableDetail.Procedure.Code"
* type.text -> "Encounter.EncounterExtension.Cpt,Encounter.EncounterExtension.Cpt,Procedure.Procedure,Procedure.CodeTableDetail.Procedure.Code"