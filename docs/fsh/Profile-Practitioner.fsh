...
* ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/structuredefinition-compliesWithProfile"
* ^extension[=].valueCanonical = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-practitioner|7.0.0"
...
* identifier[NPI].system -> "376-1: fixed value = http://hl7.org/fhir/sid/us-npi" "generated from mapParameter row 1"
* identifier[NPI].type -> "376-2: fixed value = http://terminology.hl7.org/CodeSystem/v2-0203#NPI" "generated from mapParameter row 2"
* identifier[va-DEA].value -> "377: source value based on NEW PERSON - DEA# (200-53.2)" "changed .code from PRN to DEA"
* identifier[va-DEA].system -> "377-1: fixed value = urn:oid:2.16.840.1.113883.4.814" "generated from mapParameter row 1"
* identifier[va-DEA].type -> "377-2: fixed value = http://terminology.hl7.org/CodeSystem/v2-0203#DEA" "generated from mapParameter row 2"
...
* identifier[va-nr].system -> "378-1: fixed value = urn:oid:2.16.840.1.113883.4.349" "generated from mapParameter row 1"
* identifier[va-nr].type -> "378-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/200-53.3#VA_Number" "generated from mapParameter row 2"
...
* identifier[va-VPID].system -> "379-1: fixed value = urn:oid:2.16.840.1.113883.4.349" "generated from mapParameter row 1"
* identifier[va-VPID].type -> "379-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/200-9000#VPID" "generated from mapParameter row 2"
...
* name.family -> "382-1: source value based on NEW PERSON - NAME COMPONENTS > NAME COMPONENTS - FAMILY (LAST) NAME (200-10.1 > 20-1)" "generated from mapParameter row 1"
* name.given -> "382-2: source value based on NEW PERSON - NAME COMPONENTS > NAME COMPONENTS - GIVEN (FIRST) NAME (200-10.1 > 20-2)" "generated from mapParameter row 2"
* name.prefix -> "382-3: source value based on NEW PERSON - NAME COMPONENTS > NAME COMPONENTS - PREFIX (200-10.1 > 20-4)" "generated from mapParameter row 3"
* name.suffix -> "382-4: source value based on NEW PERSON - NAME COMPONENTS > NAME COMPONENTS - SUFFIX (200-10.1 > 20-5)" "generated from mapParameter row 4"
* telecom.value -> "383: source value based on NEW PERSON - PHONE (HOME) (200-.131)"
* telecom.system -> "383-1: fixed value = #phone" "generated from mapParameter row 1"
* telecom.use -> "383-2: fixed value = #home" "generated from mapParameter row 2"
...
* identifier[va-IEN].system -> "415-1: fixed value = http://va.gov/identifiers/$Sta3n/200" "generated from mapParameter row 1"
* identifier[va-IEN].type -> "415-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/200-.001#IEN" "generated from mapParameter row 2"
