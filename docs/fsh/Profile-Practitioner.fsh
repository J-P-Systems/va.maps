...
* identifier[va-DEA].value -> "SStaff.PrescribingProvider.DEA\nSStaff.SStaff.DEA"
* identifier[va-nr].value -> "SStaff.PrescribingProvider.VANumber\nSStaff.SStaff.VANumber"
* identifier[va-VPID].value -> "SStaff.PrescribingProvider.VPID\nSStaff.SStaff.VAPersonIdentificationNumber"
* name.text -> "SStaff.SStaff.FirstName\nSStaff.SStaff.LastName\nSStaff.SStaff.MiddleName\nSStaff.SStaff.StaffNamePrefix\nSStaff.SStaff.StaffNameSuffix"
* name.family -> "SStaff.SStaff.FirstName\nSStaff.SStaff.LastName\nSStaff.SStaff.MiddleName\nSStaff.SStaff.StaffNamePrefix\nSStaff.SStaff.StaffNameSuffix"
* name.given -> "SStaff.SStaff.FirstName\nSStaff.SStaff.LastName\nSStaff.SStaff.MiddleName\nSStaff.SStaff.StaffNamePrefix\nSStaff.SStaff.StaffNameSuffix"
* name.prefix -> "SStaff.SStaff.FirstName\nSStaff.SStaff.LastName\nSStaff.SStaff.MiddleName\nSStaff.SStaff.StaffNamePrefix\nSStaff.SStaff.StaffNameSuffix"
* name.suffix -> "SStaff.SStaff.FirstName\nSStaff.SStaff.LastName\nSStaff.SStaff.MiddleName\nSStaff.SStaff.StaffNamePrefix\nSStaff.SStaff.StaffNameSuffix"
* telecom.value -> "SStaff.PrescribingProvider.HomePhone\nSStaff.SStaff.HomePhone"
* birthDate -> "SStaff.SStaff.BirthDateTime\nStaff.Staff.BirthDateTime"
* qualification.code.text -> "SStaff.SStaff.Degree\nStaff.Staff.Degree"
* gender -> "SStaff.SStaff.Gender\nStaff.Staff.Gender"