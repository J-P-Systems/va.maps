...
* telecom[va-work].system -> "384-1: fixed value = #phone" "generated from mapParameter row 1"
* telecom[va-work].use -> "384-2: fixed value = #work" "generated from mapParameter row 2"
...
* telecom[va-phone3].system -> "385-1: fixed value = #phone" "generated from mapParameter row 1"
...
* telecom[va-phone4].system -> "386-1: fixed value = #phone" "generated from mapParameter row 1"
...
* telecom[va-commercial].system -> "387-1: fixed value = #phone" "generated from mapParameter row 1"
* telecom[va-commercial].use -> "387-2: fixed value = #work" "generated from mapParameter row 2"
...
* telecom[va-fax].system -> "388-1: fixed value = #fax" "generated from mapParameter row 1"
* telecom[va-fax].use -> "388-2: fixed value = #work" "generated from mapParameter row 2"
...
* telecom[va-voice-pager].system -> "389-1: fixed value = #pager" "generated from mapParameter row 1"
...
* telecom[va-data-pager].system -> "390-1: fixed value = #pager" "generated from mapParameter row 1"
...
* telecom[va-mail].system -> "391-1: fixed value = #email" "generated from mapParameter row 1"
...
* specialty.coding.system -> "419-1: fixed value = http://nucc.org/provider-taxonomy" "generated from mapParameter row 1"
* specialty.coding.display -> "419-2: fixed value = concat({PROVIDER TYPE (.01)}, {CLASSIFICATION (1)}, {AREA OF SPECIALIZATION (2)})" "generated from mapParameter row 2"
...
* code.coding.system -> "1408-1: fixed value = http://nucc.org/provider-taxonomy" "generated from mapParameter row 1"
* code.coding.display -> "1408-2: source value based on NEW PERSON - PERSON CLASS > PERSON CLASS - Person Class > PERSON CLASS - CLASSIFICATION (200-8932.1 > 200.05-.01 > 8932.1-1)" "generated from mapParameter row 2"
