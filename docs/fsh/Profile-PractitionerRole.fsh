...
Source: PractitionerRole
* telecom[va-work].value -> "SStaff.PrescribingProvider.OfficePhone\nSStaff.SStaff.OfficePhone"
* telecom[va-phone3].value -> "SStaff.SStaff.Phone3"
* telecom[va-phone4].value -> "SStaff.SStaff.Phone4"
* telecom[va-commercial].value -> "SStaff.PrescribingProvider.CommercialPhone\nSStaff.SStaff.CommercialPhone"
* telecom[va-fax].value -> "SStaff.PrescribingProvider.FaxNumber\nSStaff.SStaff.FaxNumber"
* telecom[va-voice-pager].value -> "SStaff.PrescribingProvider.VoicePager\nSStaff.SStaff.VoicePager"
* telecom[va-data-pager].value -> "SStaff.PrescribingProvider.DigitalPager\nSStaff.SStaff.DigitalPager"
* telecom[va-mail].value -> "SStaff.PrescribingProvider.EmailAddress\nSStaff.SStaff.EmailAddress"
