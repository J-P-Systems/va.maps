...
* code.coding[va-code].system -> "1580-1: fixed value = http://va.gov/terminology/vistaDefinedTerms/9999999.15" "generated from mapParameter row 1"
* code.coding[va-code].code -> "1580-2: source value based on V EXAM - EXAM > EXAM - NAME (9000010.13-.01 > 9999999.15-.01)" "generated from mapParameter row 2"
* code.coding[va-code].display -> "1580-3: source value based on V EXAM - EXAM > EXAM - PRINT NAME (9000010.13-.01 > 9999999.15-200)" "generated from mapParameter row 3"
...
* code.coding[va-sct].system -> "1581-1: fixed value = urn:see-termmap-in-mapParameter" "generated from mapParameter row 1"
* code.coding[va-sct].code -> "1581-2: source value based on V EXAM - EXAM > EXAM - CODE MAPPINGS > CODE MAPPINGS - CODE (9000010.13-.01 > 9999999.15-210>9999999.18-1)" "generated from mapParameter row 2"
...
* valueQuantity.unit -> "1586-1: source value based on V EXAM - UCUM CODE > UCUM CODES - DESCRIPTION OF THE UNIT (9000010.13-221 > 757.5-.01)" "generated from mapParameter row 1"
* valueQuantity.code -> "1586-2: source value based on V EXAM - UCUM CODE > UCUM CODES - UCUM CODE (9000010.13-221 > 757.5-1)" "generated from mapParameter row 2"
...
Source: ObservationEXAM
* code.coding[va-code] -> "PhysicalExam.PhysExamCode,PhysicalExam.PhysExamCode[PhysExam].Description"
* code.coding[va-code].code -> "PhysicalExam.PhysExamCode,PhysicalExam.PhysExamCode[PhysExam].Description"
* code.coding[va-code].display -> "PhysicalExam.PhysExamCode,PhysicalExam.PhysExamCode[PhysExam].Description"
* code.coding[va-sct] -> "PhysicalExam.PhysExamCode,PhysicalExam.PhysExamCode[PhysExam].Description"
* code.coding[va-sct].code -> "PhysicalExam.PhysExamCode,PhysicalExam.PhysExamCode[PhysExam].Description"
