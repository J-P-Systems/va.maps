...
Source: MedicationRequestPending
* identifier.value -> "RxOut.PendingRxOrder.PlacerCPRSOrderIEN\nRxOut.PendingRxOrder.PlacerCPRSOrderSID"
...
* recorder -> "RxOut.PendingRxOrder.EnteredByStaffIEN\nRxOut.PendingRxOrder.EnteredByStaffSID"
* requester -> "RxOut.PendingRxOrder.ProviderIEN\nRxOut.PendingRxOrder.ProviderSID"
* dosageInstruction.timing.repeat.boundsPeriod.start -> "RxOut.PendingRxOrder.EffectiveDateTime\nRxOut.PharmacyInstructions.EffectiveDateTime\nRxOut.ProviderComments.EffectiveDateTime"
* medicationCodeableConcept -> "RxOut.PendingRxOrder.PharmacyOrderableItemIEN\nRxOut.PendingRxOrder.PharmacyOrderableItemSID"
* medicationCodeableConcept -> "RxOut.PendingRxOrder.LocalDrugIEN\nRxOut.PendingRxOrder.LocalDrugSID"
