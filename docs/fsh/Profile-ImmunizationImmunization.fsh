...
* location -> "Vaccination.EncounterNumber\nVaccination.EnteredAt\nVaccination.Administration.AdministeredAtLocation\nEncounter.ExternalId\nEncounter.HealthCareFacility"

Mapping: vpr-to-ImmunizationImmunization
Id: vpr
Title: "Virtual Patient Record XML (VPR)"
Source: ImmunizationImmunization
* statusReason -> "immunization.cvx (>9999999.14-.03)\nimmunization.name (>9999999.14-.01)"
* vaccineCode -> "immunization.cvx (>9999999.14-.03)\nimmunization.name (>9999999.14-.01)"
* primarySource -> "immunization.source (>920.1-.01)\nimmunization.source (>920.1-.02)"
* status -> "immunization.cvx (>9999999.14-.03)\nimmunization.name (>9999999.14-.01)"
* status -> "immunization.cvx (>9999999.14-.03)\nimmunization.name (>9999999.14-.01)"
* status -> "immunization.cvx (>9999999.14-.03)\nimmunization.name (>9999999.14-.01)"
* vaccineCode.coding[va-cvx].code -> "immunization.cvx (>9999999.14-.03)\nimmunization.name (>9999999.14-.01)"
* vaccineCode.text -> "immunization.cvx (>9999999.14-.03)\nimmunization.name (>9999999.14-.01)"
