...
* vaccineCode.text -> "332-1: source value based on V IMMUNIZATION - IMMUNIZATION > IMMUNIZATION - NAME (9000010.11-.01 > 9999999.14-.01) if not null" "generated from mapParameter row 1"
* vaccineCode.coding[va-cvx].system -> "332-2: fixed value = http://hl7.org/fhir/sid/cvx if not null" "generated from mapParameter row 2"
...
* vaccineCode.coding[va-ndc].system -> "1609-1: fixed value = http://hl7.org/fhir/sid/ndc" "generated from mapParameter row 1"
...
* performer.function -> "342-1: fixed value = http://terminology.hl7.org/CodeSystem/v2-0443#AP" "generated from mapParameter row 1"
...
* doseQuantity.unit -> "464-1: source value based on V IMMUNIZATION - DOSE UNITS > UCUM CODES - DESCRIPTION OF THE UNIT (9000010.11-1313 > 757.5-.01)" "generated from mapParameter row 1"
* doseQuantity.code -> "464-2: source value based on V IMMUNIZATION - DOSE UNITS > UCUM CODES - UCUM CODE (9000010.11-1313 > 757.5-1)" "generated from mapParameter row 2"
