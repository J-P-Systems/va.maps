Instance: VF-DPPLungCancerScreeningFind
InstanceOf: ConceptMap
Usage: #definition
* url = "http://va.gov/fhir/ConceptMap/VF-DPPLungCancerScreeningFind"
* name = "VF_DPPLungCancerScreeningFind"
* title = "VF_DPPLungCancerScreeningFind"
* status = #active
* experimental = false
* description = "Terminology Maps VF_DPPLungCancerScreeningFind"
* sourceCanonical = "http://va.gov/fhir/ValueSet/DPPLungCancerScreeningFind-vista"
* targetCanonical = "http://va.gov/fhir/ValueSet/DPPLungCancerScreeningFind"
...
ValueSet: DPPLungCancerScreeningFind
Title: "DPPLungCancerScreeningFind FHIR"
Description: "FHIR Target ValueSet for Terminology Maps [VF_DPPLungCancerScreeningFind](ConceptMap-VF-DPPLungCancerScreeningFind.html)"
* ^experimental = false
* ^status = #active
* ^name = "DPPLungCancerScreeningFind"
...
ValueSet: DPPLungCancerScreeningFind-vista
Title: "DPPLungCancerScreeningFind VistA"
Description: "VistA Source ValueSet for Terminology Maps [VF_DPPLungCancerScreeningFind](ConceptMap-VF-DPPLungCancerScreeningFind.html)"
* ^experimental = false
* ^status = #active
* ^name = "DPPLungCancerScreeningFind_VistA"
