...
* extension[http://va.gov/fhir/StructureDefinition/medicationrequest-pharmacyOrderStatus].valueCoding.system -> "800-1: fixed value = http://va.gov/terminology/vistaDefinedTerms/52-100" "generated from mapParameter row 1"
...
* medicationCodeableConcept.coding.system -> "805-1: fixed value = http://www.nlm.nih.gov/research/umls/rxnorm" "generated from mapParameter row 1"
...
* identifier.type -> "1664-1: fixed value = http://terminology.hl7.org/CodeSystem/v2-0203#FILL" "generated from mapParameter row 1"
...
* dosageInstruction.route.coding.system -> "1665-1: fixed value = http://va.gov/terminology/vistaDefinedTerms/53.1-3" "generated from mapParameter row 1"
...
* extension[http://va.gov/fhir/StructureDefinition/medicationrequest-pharmacyOrderStatus].valueCoding.system -> "1746-1: fixed value = http://va.gov/terminology/vistaDefinedTerms/52-100 if P" "generated from mapParameter row 1"
