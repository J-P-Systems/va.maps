...
* extension[http://va.gov/fhir/StructureDefinition/medicationrequest-pharmacyOrderStatus].valueCoding.system -> "800-1: fixed value = http://va.gov/terminology/vistaDefinedTerms/52-100" "mapParameter row 1"
...
* medicationCodeableConcept.coding.system -> "805-1: fixed value = http://www.nlm.nih.gov/research/umls/rxnorm" "mapParameter row 1"
...
* dosageInstruction.route.coding.system -> "1665-1: fixed value = http://va.gov/terminology/vistaDefinedTerms/53.1-3" "mapParameter row 1"
...
* extension[http://va.gov/fhir/StructureDefinition/medicationrequest-pharmacyOrderStatus].valueCoding.system -> "1746-1: fixed value = http://va.gov/terminology/vistaDefinedTerms/52-100 if P" "mapParameter row 1"
