...
Source: MedicationRequestOutpatient
* status -> "pharmacy.status,pharmacy.vaStatus"
* extension[http://va.gov/fhir/StructureDefinition/medicationrequest-pharmacyOrderStatus].valueCoding.code -> "pharmacy.status,pharmacy.vaStatus"
* medicationCodeableConcept.text -> "pharmacy.product [m]"
* medicationCodeableConcept.coding.code -> "pharmacy.product [m]"
* authoredOn -> "pharmacy.start"
* requester -> "pharmacy.currentProvider,pharmacy.orderingProvider"
* dosageInstruction.patientInstruction -> "pharmacy.ptInstructions"
* dosageInstruction.doseAndRate.doseQuantity.value -> "pharmacy.dose [m]"
* dosageInstruction.doseAndRate.doseQuantity.unit -> "pharmacy.dose [m]"
* dispenseRequest.validityPeriod.end -> "pharmacy.expires"
* extension[http://va.gov/fhir/StructureDefinition/medicationrequest-cancelDate].valueDateTime -> "pharmacy.stop"
* dispenseRequest.numberOfRepeatsAllowed -> "pharmacy.fillsAllowed"
* dispenseRequest.quantity.value -> "pharmacy.quantity"
* dispenseRequest.expectedSupplyDuration -> "pharmacy.daysSupply"
* dosageInstruction.doseAndRate.extension[http://hl7.org/fhir/StructureDefinition/originalText].valueString -> "pharmacy.dose [m]"
* identifier -> "pharmacy.prescription"
* dosageInstruction.route.coding.code -> "pharmacy.dose [m]"
* extension[http://va.gov/fhir/StructureDefinition/medicationrequest-pharmacyOrderStatus].valueCoding.code -> "pharmacy.routing"