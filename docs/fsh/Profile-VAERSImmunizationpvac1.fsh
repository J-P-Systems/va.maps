...
* vaccineCode.text -> "1920: source value based on ADERS - 22_PVac1_TypeBrand" "type and brand name not mfr"
* manufacturer.display -> "1921: source value based on ADERS - 22_PVac1_Mfgr" "reference back to org but we don't get a codeable just string"
* lotNumber -> "1922: source value based on ADERS - 22_PVac1_Lot"
* route.text -> "1923: source value based on ADERS - 22_PVac1_Route"
* site -> "1924: source value based on ADERS - 22_PVac1_Site"
* protocolApplied.doseNumberString -> "1925: source value based on ADERS - 22_PVac1_DoseInSeries"
* occurrenceDateTime -> "1926: source value based on ADERS - 22_PVac1_Date"
