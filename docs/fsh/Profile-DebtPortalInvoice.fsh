...
Description: "430-9 > 340-.01: if patient then Patient"
Severity: #warning
...
* lineItem[va-charges].priceComponent.amount -> "1840: source value from INTEGRATED BILLING ACTION - TOTAL CHARGE (350-.07)"
* lineItem[va-charges].priceComponent.type -> "1840-1: fixed value = #base" "from mapParameter 1"
* lineItem[va-charges].priceComponent.code.text -> "1840-2: fixed value = Total Charge" "from mapParameter 2"
* lineItem[va-interest].chargeItemReference -> "1991: reference"
* lineItem[va-interest].priceComponent[va-marshal-fee-charged].amount -> "1999: source value from AR TRANSACTION - MARSHAL FEE (433-25)"
* lineItem[va-interest].priceComponent[va-marshal-fee-charged].type -> "1999-1: fixed value = #surcharge" "from mapParameter 1"
* lineItem[va-interest].priceComponent[va-marshal-fee-charged].code.text -> "1999-2: fixed value = Marshal Fee Charged" "from mapParameter 2"
* lineItem[va-interest].priceComponent[va-court-cost-charged].amount -> "2000: source value from AR TRANSACTION - COURT COST (433-26)"
* lineItem[va-interest].priceComponent[va-court-cost-charged].type -> "2000-1: fixed value = #surcharge" "from mapParameter 1"
* lineItem[va-interest].priceComponent[va-court-cost-charged].code.text -> "2000-2: fixed value = Court Cost Charged" "from mapParameter 2"
* lineItem[va-interest].priceComponent[va-interest-charged].amount -> "2001: source value from AR TRANSACTION - INT.CHARGE (433-27)"
* lineItem[va-interest].priceComponent[va-interest-charged].type -> "2001-1: fixed value = #surcharge" "from mapParameter 1"
* lineItem[va-interest].priceComponent[va-interest-charged].code.text -> "2001-2: fixed value = Interest Charged" "from mapParameter 2"
* lineItem[va-interest].priceComponent[va-admin-charged].amount -> "2002: source value from AR TRANSACTION - ADM.CHARGE (433-28)"
* lineItem[va-interest].priceComponent[va-admin-charged].type -> "2002-1: fixed value = #surcharge" "from mapParameter 1"
* lineItem[va-interest].priceComponent[va-admin-charged].code.text -> "2002-2: fixed value = Administrative Charged" "from mapParameter 2"
