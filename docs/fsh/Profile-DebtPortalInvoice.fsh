...
* totalPriceComponent[va-orig-amt].type -> "1828-1: fixed value = #informational" "mapParameter row 1"
* totalPriceComponent[va-orig-amt].code.text -> "1828-2: fixed value = Original Amount" "mapParameter row 2"
* totalPriceComponent[va-curr-bal].amount -> "1829: source value based on ACCOUNTS RECEIVABLE - CURRENT BALANCE (430-11)"
* totalPriceComponent[va-curr-bal].type -> "1829-1: fixed value = #base" "mapParameter row 1"
* totalPriceComponent[va-curr-bal].code.text -> "1829-2: fixed value = Current Balance" "mapParameter row 2"
* totalPriceComponent[va-amend-amt].amount -> "1830: source value based on ACCOUNTS RECEIVABLE - AMENDED AMOUNT (430-35)"
* totalPriceComponent[va-amend-amt].type -> "1830-1: fixed value = #base" "mapParameter row 1"
* totalPriceComponent[va-amend-amt].code.text -> "1830-2: fixed value = Amended Amount" "mapParameter row 2"
* totalPriceComponent[va-principal-bal].amount -> "1831: source value based on ACCOUNTS RECEIVABLE - PRINCIPAL BALANCE (430-71)"
* totalPriceComponent[va-principal-bal].type -> "1831-1: fixed value = #base" "mapParameter row 1"
* totalPriceComponent[va-principal-bal].code.text -> "1831-2: fixed value = Principal Balance" "mapParameter row 2"
* totalPriceComponent[va-interest-bal].amount -> "1832: source value based on ACCOUNTS RECEIVABLE - INTEREST BALANCE (430-72)"
* totalPriceComponent[va-interest-bal].type -> "1832-1: fixed value = #surcharge" "mapParameter row 1"
* totalPriceComponent[va-interest-bal].code.text -> "1832-2: fixed value = Interest Balance" "mapParameter row 2"
...
* totalPriceComponent[va-admin-cost-bal].type -> "1866-1: fixed value = #surcharge" "mapParameter row 1"
* totalPriceComponent[va-admin-cost-bal].code.text -> "1866-2: fixed value = Administrative Cost Balance" "mapParameter row 2"
* totalPriceComponent[va-marsh-fee].amount -> "1867: source value based on ACCOUNTS RECEIVABLE - MARSHAL FEE (430-74)"
* totalPriceComponent[va-marsh-fee].type -> "1867-1: fixed value = #surcharge" "mapParameter row 1"
* totalPriceComponent[va-marsh-fee].code.text -> "1867-2: fixed value = Marshal Fee" "mapParameter row 2"
* totalPriceComponent[va-court-cost].amount -> "1868: source value based on ACCOUNTS RECEIVABLE - COURT COST (430-75)"
* totalPriceComponent[va-court-cost].type -> "1868-1: fixed value = #surcharge" "mapParameter row 1"
* totalPriceComponent[va-court-cost].code.text -> "1868-2: fixed value = Court Cost" "mapParameter row 2"
* totalPriceComponent[va-principal-paid].amount -> "1869: source value based on ACCOUNTS RECEIVABLE - TOTAL PAID PRINCIPAL (430-77)"
* totalPriceComponent[va-principal-paid].type -> "1869-1: fixed value = #base" "mapParameter row 1"
* totalPriceComponent[va-principal-paid].code.text -> "1869-2: fixed value = Principal Paid" "mapParameter row 2"
* totalPriceComponent[va-interest-paid].amount -> "1870: source value based on ACCOUNTS RECEIVABLE - TOTAL PAID INTEREST (430-78)"
* totalPriceComponent[va-interest-paid].type -> "1870-1: fixed value = #surcharge" "mapParameter row 1"
* totalPriceComponent[va-interest-paid].code.text -> "1870-2: fixed value = Interest Paid" "mapParameter row 2"
...
* totalPriceComponent[va-admin-cost-paid].type -> "1871-1: fixed value = #surcharge" "mapParameter row 1"
* totalPriceComponent[va-admin-cost-paid].code.text -> "1871-2: fixed value = Administrative Cost Paid" "mapParameter row 2"
...
* totalPriceComponent[va-marsh-fee-paid].type -> "1872-1: fixed value = #surcharge" "mapParameter row 1"
* totalPriceComponent[va-marsh-fee-paid].code.text -> "1872-2: fixed value = Marshal Fee Paid" "mapParameter row 2"
...
* totalPriceComponent[va-court-cost-paid].type -> "1873-1: fixed value = #surcharge" "mapParameter row 1"
* totalPriceComponent[va-court-cost-paid].code.text -> "1873-2: fixed value = Court Cost Paid" "mapParameter row 2"
...
* lineItem[va-charges].priceComponent.type -> "1840-1: fixed value = #base" "mapParameter row 1"
* lineItem[va-charges].priceComponent.code.text -> "1840-2: fixed value = Total Charge" "mapParameter row 2"
...
* lineItem[va-interest].priceComponent[va-marshal-fee-charged].type -> "1999-1: fixed value = #surcharge" "mapParameter row 1"
* lineItem[va-interest].priceComponent[va-marshal-fee-charged].code.text -> "1999-2: fixed value = Marshal Fee Charged" "mapParameter row 2"
...
* lineItem[va-interest].priceComponent[va-court-cost-charged].type -> "2000-1: fixed value = #surcharge" "mapParameter row 1"
* lineItem[va-interest].priceComponent[va-court-cost-charged].code.text -> "2000-2: fixed value = Court Cost Charged" "mapParameter row 2"
...
* lineItem[va-interest].priceComponent[va-interest-charged].type -> "2001-1: fixed value = #surcharge" "mapParameter row 1"
* lineItem[va-interest].priceComponent[va-interest-charged].code.text -> "2001-2: fixed value = Interest Charged" "mapParameter row 2"
* lineItem[va-interest].priceComponent[va-admin-charged].amount -> "2002: source value based on AR TRANSACTION - ADM.CHARGE (433-28)"
* lineItem[va-interest].priceComponent[va-admin-charged].type -> "2002-1: fixed value = #surcharge" "mapParameter row 1"
* lineItem[va-interest].priceComponent[va-admin-charged].code.text -> "2002-2: fixed value = Administrative Charged" "mapParameter row 2"
