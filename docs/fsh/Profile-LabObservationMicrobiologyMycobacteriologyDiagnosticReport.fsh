...
* result only Reference(LabObservationMicrobiologyMycobacteriologyObservation)
...
Mapping: source-to-LabObservationMicrobiologyMycobacteriologyDiagnosticReport
Id: vista
Title: "Veterans Health Information Systems Technology and Architecture (VistA)"
Source: LabObservationMicrobiologyMycobacteriologyDiagnosticReport
* extension[http://hl7.org/fhir/5.0/StructureDefinition/extension-DiagnosticReport.note].valueAnnotation -> "1445: source value based on MICROBIOLOGY - TB RPT REMARK > TB RPT REMARK - TB RPT REMARK (63.05-27 > 63.41-.01)" "This is the correct mapping, however, .note was not added to DR until FHIR R5. Use pre-adopt extension."
...
Mapping: sda-to-LabObservationMicrobiologyMycobacteriologyDiagnosticReport
Id: sda
