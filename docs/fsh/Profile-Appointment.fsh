...
* participant[va-clinic].type.coding.code -> "746-1: fixed value = #PART" "mapParameter row 1"
* participant[va-clinic].status -> "746-2: fixed value = #accepted" "mapParameter row 2"
...
* participant[va-patient].type.coding.code -> "1722-1: fixed value = #PART" "mapParameter row 1"
* participant[va-patient].status -> "1722-2: fixed value = #accepted" "mapParameter row 2"
...
* serviceCategory[va-stop-code].coding.system -> "749-1: fixed value = http://va.gov/terminology/VistADefinedTerms/409.3-13.4" "mapParameter row 1"
...
* participant[va-apptclinic].type.coding.code -> "754-1: fixed value = #PART" "mapParameter row 1"
* participant[va-apptclinic].status -> "754-2: fixed value = #tentative" "mapParameter row 2"
...
* participant.status -> "2038-1: fixed value = #tentative" "mapParameter row 1"
