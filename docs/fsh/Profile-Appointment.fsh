...
* participant[va-clinic].type.coding.code -> "746-1: fixed value = #PART" "generated from mapParameter row 1"
* participant[va-clinic].status -> "746-2: fixed value = #accepted" "generated from mapParameter row 2"
