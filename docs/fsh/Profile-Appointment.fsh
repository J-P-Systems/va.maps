...
Source: Appointment
* status -> "Appointment.NoShow,Appointment.AppointmentExtension.PatientStatus,Appointment.AppointmentExtension.ServiceStatus"
* status -> "Appointment.NoShow,Appointment.AppointmentExtension.PatientStatus,Appointment.AppointmentExtension.ServiceStatus"
* status -> "Appointment.NoShow,Appointment.AppointmentExtension.PatientStatus,Appointment.AppointmentExtension.ServiceStatus"
* status -> "Appointment.NoShow,Appointment.AppointmentExtension.PatientStatus,Appointment.AppointmentExtension.ServiceStatus"
* extension[http://va.gov/fhir/StructureDefinition/resource-serviceConnection].valueCoding -> "Appointment.Type"
* extension[http://va.gov/fhir/StructureDefinition/resource-serviceConnection].valueCoding -> "Appointment.Type"
* cancelationReason -> "Appointment.AppointmentExtension.CancelReason"
...
* end -> "Appointment.CareProvider,Appointment.EncounterNumber,Appointment.AppointmentExtension.AssociatedEncounterNumber"
* minutesDuration -> "Appointment.AppointmentExtension.Length"
