...
* vaccineCode.text -> "1927: source value based on ADERS - 22_PVac2_TypeBrand"
* manufacturer.display -> "1928: source value based on ADERS - 22_PVac2_Mfgr"
* lotNumber -> "1929: source value based on ADERS - 22_PVac2_Lot"
* route -> "1930: source value based on ADERS - 22_PVac2_Route"
* site -> "1931: source value based on ADERS - 22_PVac2_Site"
* protocolApplied.doseNumberString -> "1932: source value based on ADERS - 22_PVac2_DoseInSeries"
* occurrenceDateTime -> "1933: source value based on ADERS - 22_PVac2_Date"
