...
Mapping: source-to-LabObservationCytopathologyDiagnosticReport
Id: vista
...
* identifier.system -> "1603-1: fixed value = http://va.gov/identifiers/$Sta3n/63.51" "generated from mapParameter row 1"
...
Mapping: sda-to-LabObservationCytopathologyDiagnosticReport
Id: sda
