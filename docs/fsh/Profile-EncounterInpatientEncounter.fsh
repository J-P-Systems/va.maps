...
* identifier[va-IEN].system -> "427-1: fixed value = http://va.gov/identifiers/$Sta3n/45" "mapParameter row 1"
* identifier[va-IEN].type.text -> "427-2: fixed value = IEN" "mapParameter row 2"
...
* identifier[va-IA].system -> "428-1: fixed value = http://va.gov/identifiers/$Sta3n/45-2.1" "mapParameter row 1"
* identifier[va-IA].type.text -> "428-2: fixed value = Internal Admission #" "mapParameter row 2"
...
* participant.type.coding -> "442-1: fixed value = http://terminology.hl7.org/CodeSystem/v3-ParticipationType#PPRF" "mapParameter row 1"
...
* reasonCode[va-principle].coding.system -> "448-1: fixed value = urn:see-termmap-in-mapParameter" "mapParameter row 1"
* diagnosis.condition -> "1723: reference" "This points to the Condition identified at #956"
* diagnosis.rank -> "1723-1: fixed value = 1" "mapParameter row 1"
...
* reasonCode[va-secondary].coding.system -> "449-1: fixed value = urn:see-termmap-in-mapParameter" "mapParameter row 1"
...
* reasonCode[va-procedure].coding.system -> "450-1: fixed value = http://www.cms.gov/Medicare/Coding/ICD10" "mapParameter row 1"
...
* hospitalization.admitSource.coding.system -> "453-1: fixed value = http://va.gov/terminology/vistaDefinedTerms/45.1" "mapParameter row 1"
...
* hospitalization.dischargeDisposition.coding.system -> "456-1: fixed value = http://va.gov/terminology/vistaDefinedTerms/45.6" "mapParameter row 1"
...
* type.coding.system -> "1616-1: fixed value = http://www.ama-assn.org/go/cpt" "mapParameter row 1"
* type.coding.code -> "1616-2: source value based on INPATIENT CPT CODE - CPT CODE > CPT - CPT CODE (46-.01 > 81-.01)" "mapParameter row 2"
* type.coding.display -> "1616-3: source value based on INPATIENT CPT CODE - CPT CODE > CPT - SHORT NAME (46-.01 > 81-2)" "mapParameter row 3"
* type.text -> "1616-4: source value based on INPATIENT CPT CODE - CPT CODE > CPT - SHORT NAME (46-.01 > 81-2)" "mapParameter row 4"
