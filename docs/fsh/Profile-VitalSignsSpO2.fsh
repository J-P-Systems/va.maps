...
* ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/structuredefinition-compliesWithProfile"
* ^extension[=].valueCanonical = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-pulse-oximetry|7.0.0"
...
* component[FlowRate].valueQuantity.code -> "1239-1: fixed value = #L/min if VUID = 4500637" "generated from mapParameter line 1"
* component[FlowRate].valueQuantity.unit -> "1239-2: fixed value = L/min if VUID = 4500637" "generated from mapParameter line 2"
* component[FlowRate].code -> "1239-3: fixed value = http://loinc.org#3151-8 if VUID = 4500637" "generated from mapParameter line 3"
...
* component[Concentration].valueQuantity.code -> "1240-1: fixed value = #% if VUID = 4500637" "generated from mapParameter line 1"
* component[Concentration].valueQuantity.unit -> "1240-2: fixed value = % if VUID = 4500637" "generated from mapParameter line 2"
* component[Concentration].code -> "1240-3: fixed value = http://loinc.org#3150-0 if VUID = 4500637" "generated from mapParameter line 3"
