...
Source: VitalSignsSpO2
* component[FlowRate].valueQuantity.value -> "Observation.ObservationExtension.SupplementalO2"
* component[Concentration].valueQuantity.value -> "Observation.ObservationExtension.SupplementalO2"
