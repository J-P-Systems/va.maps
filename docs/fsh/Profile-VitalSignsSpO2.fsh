...
* component[FlowRate].valueQuantity.code -> "1239-1: fixed value = L/min if VUID = 4500637" "mapParameter row 1"
* component[FlowRate].code.coding.system -> "1239-2: fixed value = http://loinc.org if VUID = 4500637" "mapParameter row 2"
* component[FlowRate].code.coding.code -> "1239-3: fixed value = 3151-8 if VUID = 4500637" "mapParameter row 3"
...
* component[Concentration].valueQuantity.code -> "1240-1: fixed value = % if VUID = 4500637" "mapParameter row 1"
* component[Concentration].code.coding.system -> "1240-2: fixed value = http://loinc.org if VUID = 4500637" "mapParameter row 2"
* component[Concentration].code.coding.code -> "1240-3: fixed value = 3150-0 if VUID = 4500637" "mapParameter row 3"
