...
* category -> "2132: target not supported" "auto added because of must-support"
...
* valueQuantity -> "2136: target not supported" "auto added because of must-support"
* valueCodeableConcept -> "2137: target not supported" "auto added because of must-support"
