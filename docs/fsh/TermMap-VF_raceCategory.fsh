...
* include http://va.gov/terminology/vistaDefinedTerms/2-2#3 "AMERICAN INDIAN OR ALASKA NATIVE"
* include http://va.gov/terminology/vistaDefinedTerms/2-2#B "BLACK OR AFRICAN AMERICAN"
* include http://va.gov/terminology/vistaDefinedTerms/2-2#H "NATIVE HAWAIIAN OR OTHER PACIFIC ISLANDER"
* include http://va.gov/terminology/vistaDefinedTerms/2-2#W "WHITE"
* include http://va.gov/terminology/vistaDefinedTerms/2-2#6 "WHITE NOT OF HISP ORIG"