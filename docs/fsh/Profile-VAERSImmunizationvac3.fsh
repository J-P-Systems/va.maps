...
* vaccineCode -> "1893: source value based on ADERS - 17_Vac3_TypeBrand"
* manufacturer.display -> "1894: source value based on ADERS - 17_Vac3_Mfgr"
* lotNumber -> "1895: source value based on ADERS - 17_Vac3_Lot"
* route -> "1896: source value based on ADERS - 17_Vac3_Route"
* site -> "1897: source value based on ADERS - 17_Vac3_Site"
* protocolApplied.doseNumberString -> "1898: source value based on ADERS - 17_Vac3_DoseInSeries"
