...
* result only Reference(LabObservationMicrobiologyParasitologyObservation)
...
Mapping: source-to-LabObservationMicrobiologyParasitologyDiagnosticReport
Id: vista
Title: "Veterans Health Information Systems Technology and Architecture (VistA)"
Source: LabObservationMicrobiologyParasitologyDiagnosticReport
* extension[http://hl7.org/fhir/5.0/StructureDefinition/extension-DiagnosticReport.note].valueAnnotation -> "1443: source value based on MICROBIOLOGY - PARASITE RPT REMARK > PARASITE RPT REMARK - PARASITE RPT REMARK (63.05-17 > 63.36-.01)" "This is the correct mapping, however, .note was not added to DR until FHIR R5. Use pre-adopt extension."
...
Source: LabObservationMicrobiologyParasitologyDiagnosticReport
* extension[http://hl7.org/fhir/5.0/StructureDefinition/extension-DiagnosticReport.note].valueAnnotation -> "Micro.ParasitologyReports.ParasitologyReportRemark"
