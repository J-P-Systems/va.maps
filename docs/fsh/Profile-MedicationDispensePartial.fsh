...
* quantity.value -> "pharmacy.fill [m]"
* status -> "pharmacy.fill [m]"
* status -> "pharmacy.fill [m]"
* whenPrepared -> "pharmacy.fill [m]"
* location -> "pharmacy.fill [m]"
* note.text -> "pharmacy.fill [m]"
* performer.actor -> "pharmacy.fill [m]"