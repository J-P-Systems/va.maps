...
* category -> "2066: target not supported" "auto added because of must-support"
...
* valueQuantity -> "2070: target not supported" "auto added because of must-support"
* valueCodeableConcept -> "2071: target not supported" "auto added because of must-support"
