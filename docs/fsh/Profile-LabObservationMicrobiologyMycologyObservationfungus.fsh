...
* category -> "2102: target not supported" "auto added because of must-support"
...
* valueQuantity -> "2106: target not supported" "auto added because of must-support"
* valueCodeableConcept -> "2107: target not supported" "auto added because of must-support"
