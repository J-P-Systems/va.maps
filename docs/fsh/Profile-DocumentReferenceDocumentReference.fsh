...
* identifier.system -> "871-1: fixed value = http://va.gov/identifiers/$Sta3n/8925" "generated from mapParameter row 1"
...
* type.coding.system -> "874-1: fixed value = http://loinc.org" "generated from mapParameter row 1"
