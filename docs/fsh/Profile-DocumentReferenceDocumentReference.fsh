...
* identifier.system -> "871-1: fixed value = http://va.gov/identifiers/$Sta3n/8925" "mapParameter row 1"
...
* type.coding.system -> "874-1: fixed value = http://loinc.org" "mapParameter row 1"
* type.coding.code -> "874-2: source value based on TIU DOCUMENT - DOCUMENT TYPE > TIU DOCUMENT DEFINITION - VHA ENTERPRISE STANDARD TITLE > TIU VHA ENTERPRISE STANDARD TITLE - CODING SYSTEM (8925-.01 > 8925.1-1501 > 8926.1-2)" "mapParameter row 2"
* type.text -> "874-3: source value based on TIU DOCUMENT - DOCUMENT TYPE > TIU DOCUMENT DEFINITION - VHA ENTERPRISE STANDARD TITLE > TIU VHA ENTERPRISE STANDARD TITLE - DOCUMENT TYPE (8925-.01 > 8925.1-1501 > 8926.1-.08)" "mapParameter row 3"
