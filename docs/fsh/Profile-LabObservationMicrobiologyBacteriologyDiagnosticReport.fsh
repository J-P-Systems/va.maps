...
* result only Reference(LabObservationMicrobiologyBacteriologyObservation)
...
* extension[http://hl7.org/fhir/5.0/StructureDefinition/extension-DiagnosticReport.note].valueAnnotation -> "1442: source value based on MICROBIOLOGY - BACT RPT REMARK > BACT RPT REMARK - BACT RPT REMARK (63.05-13 > 63.33-.01)" "This is the correct mapping, however, .note was not added to DR until FHIR R5. Use pre-adopt extension."
