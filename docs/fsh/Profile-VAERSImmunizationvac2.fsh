...
* vaccineCode -> "1887: source value based on ADERS - 17_Vac2_TypeBrand"
* manufacturer.display -> "1888: source value based on ADERS - 17_Vac2_Mfgr"
* lotNumber -> "1889: source value based on ADERS - 17_Vac2_Lot"
* route -> "1890: source value based on ADERS - 17_Vac2_Route"
* site -> "1891: source value based on ADERS - 17_Vac2_Site"
* protocolApplied.doseNumberString -> "1892: source value based on ADERS - 17_Vac2_DoseInSeries"
