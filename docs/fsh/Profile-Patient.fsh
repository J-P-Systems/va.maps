...
* identifier.system -> "272-1: fixed value = urn:oid:2.16.840.1.113883.4.349" "generated from mapParameter row 1"
* identifier.type.coding.code -> "272-2: fixed value = #MR" "generated from mapParameter row 2"
* identifier.type.coding.system -> "272-3: fixed value = http://terminology.hl7.org/CodeSystem/v2-0203" "generated from mapParameter row 3"
* name.text -> "273: source value based on PATIENT - NAME (2-.01)"
* name.family -> "273-1: fixed value = LAST" "generated from mapParameter row 1"
* name.given -> "273-2: fixed value = FIRST & MIDDLE" "generated from mapParameter row 2"
* name.suffix -> "273-3: fixed value = SUFFIX" "generated from mapParameter row 3"
* telecom[va-home].value -> "274: source value based on PATIENT - PHONE NUMBER [RESIDENCE] (2-.131)"
* telecom[va-home].system -> "274-1: fixed value = #phone" "generated from mapParameter row 1"
* telecom[va-home].use -> "274-2: fixed value = #home" "generated from mapParameter row 2"
* telecom[va-work].value -> "275: source value based on PATIENT - PHONE NUMBER [WORK] (2-.132)"
* telecom[va-work].system -> "275-1: fixed value = #phone" "generated from mapParameter row 1"
* telecom[va-work].use -> "275-2: fixed value = #work" "generated from mapParameter row 2"
* telecom[va-mobile].value -> "276: source value based on PATIENT - PHONE NUMBER [CELLULAR] (2-.134)"
* telecom[va-mobile].system -> "276-1: fixed value = #phone" "generated from mapParameter row 1"
* telecom[va-mobile].use -> "276-2: fixed value = #mobile" "generated from mapParameter row 2"
...
* address[va-home].use -> "286-1: fixed value = #home" "generated from mapParameter row 1"
* address[va-home].type -> "286-2: fixed value = #postal" "generated from mapParameter row 2"
...
* extension[http://hl7.org/fhir/us/core/StructureDefinition/us-core-ethnicity].extension[text].valueString -> "575-1: source value based on PATIENT - ETHNICITY INFORMATION > undefinedETHNICITY INFORMATION (2-6 > undefined6)" "generated from mapParameter row 1"
...
* extension[http://hl7.org/fhir/us/core/StructureDefinition/us-core-race].extension[text].valueString -> "576-1: source value based on PATIENT - RACE INFORMATION > undefinedINFORMATION (2-2 > undefined2)" "generated from mapParameter row 1"
