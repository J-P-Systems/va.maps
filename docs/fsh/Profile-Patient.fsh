...
* address[va-home].state -> "SPatient.SPatientGISAddress.StateIEN\nSPatient.SPatientGISAddress.StateSID"
...
* extension[http://hl7.org/fhir/us/core/StructureDefinition/us-core-genderIdentity].valueCodeableConcept -> "Patient.Patient.SelfIdentifiedGender\nSPatient.SPatient.SelfIdentifiedGender"
...
* deceasedDateTime -> "Patient.DeathTime\nPatient.IsDead"
