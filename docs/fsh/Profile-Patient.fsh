...
* birthDate -> "Patient.BirthTime,Patient.PatientExtension.Dob"
* deceasedDateTime -> "Patient.DeathTime,Patient.IsDead"
* address[va-home].line -> "Patient.Address.Street"
* address[va-home].line -> "Patient.Address.Street"
* address[va-home].line -> "Patient.Address.Street"
* address[va-home].city -> "Patient.Address.City"
* address[va-home].state -> "Patient.Address.State"
* address[va-home].country -> "Patient.Address.Country"
* address[va-home].period.start -> "Patient.Address.FromTime"
* address[va-home].period.end -> "Patient.Address.ToTime"
