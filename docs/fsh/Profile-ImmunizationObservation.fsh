...
* valueCodeableConcept.coding.system -> "1595-1: fixed value = http://va.gov/terminology/vistaDefinedTerms/9000010.11-.06" "generated from mapParameter row 1"
* valueCodeableConcept.text -> "1596: source value based on V IMMUNIZATION - REACTION (9000010.11-.06)" "identified byMHV"
