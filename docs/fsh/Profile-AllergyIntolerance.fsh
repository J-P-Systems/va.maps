...
* code -> "Allergy.Allergy,Allergy.AllergyExtension.OriginalCode"
* patient -> "Allergy.ATCCode"
* recorder -> "Allergy.EnteredBy"
* reaction.manifestation -> "Allergy.Reaction,Allergy.AllergyExtension.Reactions"
* reaction.manifestation.coding.code -> "Allergy.Reaction,Allergy.AllergyExtension.Reactions"
* reaction.manifestation.coding.display -> "Allergy.Reaction,Allergy.AllergyExtension.Reactions"
* reaction.manifestation.text -> "Allergy.Reaction,Allergy.AllergyExtension.Reactions"
* type -> "Allergy.AllergyExtension.Mechanism"
...
* reaction.severity -> "Allergy.Severity,Allergy.VA.AllergyObservation.Severity"
* note.time -> "Allergy.Comments,Allergy.InactiveComments,Allergy.AllergyExtension.Comments"
* note.authorString -> "Allergy.Comments,Allergy.InactiveComments,Allergy.AllergyExtension.Comments\nAllergy.VA.Comment.EnteredBy"
* note.text -> "Allergy.Comments,Allergy.InactiveComments,Allergy.AllergyExtension.Comments\nAllergy.VA.Comment.CommentText"
* code -> "Allergy.AllergyExtension.DrugProducts"
* reaction.onset -> "Allergy.Reaction,Allergy.AllergyExtension.Reactions\nAllergy.Reaction.Extension,Allergy.ReactionExtension.EnteredOn"