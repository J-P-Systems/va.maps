...
Invariant: ai-18-557
Description: "If {.03>120.8} then terminologyMaps (120.85-14.5) using VF_allergySeverity"
Severity: #warning
Expression: "true"
...
* reaction.severity -> "557: terminologyMaps using VF_allergySeverity on ADVERSE REACTION REPORTING - SEVERITY (120.85-14.5) if {.03>120.8}" "This Data is not in CDW\nAssess for CHAPI via VPR"
