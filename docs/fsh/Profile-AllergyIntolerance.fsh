...
* ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/structuredefinition-compliesWithProfile"
* ^extension[=].valueCanonical = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-allergyintolerance|7.0.0"
...
* identifier[va-IEN].system -> "233-1: fixed value = http://va.gov/identifiers/$Sta3n/120.8" "generated from mapParameter row 1"
...
* reaction.manifestation.coding.display -> "252-3: source value based on PATIENT ALLERGIES - REACTIONS > REACTIONS - REACTION > SIGN/SYMPTOMS - NAME (120.8-10 > 120.81-.01 > 120.83-.01)" "generated from mapParameter row 3"
* reaction.manifestation.text -> "252-4: source value based on PATIENT ALLERGIES - REACTIONS > REACTIONS - REACTION > SIGN/SYMPTOMS - NAME (120.8-10 > 120.81-.01 > 120.83-.01)" "generated from mapParameter row 4"
