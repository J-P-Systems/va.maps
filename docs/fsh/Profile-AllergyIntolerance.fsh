...
* reaction.manifestation -> "reaction.reaction [m]"
* reaction.manifestation.coding.code -> "reaction.reaction [m]"
* reaction.manifestation.coding.display -> "reaction.reaction [m]"
* reaction.manifestation.text -> "reaction.reaction [m]"
* type -> "reaction.mechanism"
* clinicalStatus -> "reaction.removed"
* verificationStatus -> "reaction.removed"
* category -> "reaction.type"
* note.time -> "reaction.comment [m]"
* note.authorString -> "reaction.comment [m]"
* note.text -> "reaction.comment [m]"
* code -> "reaction.drugIngredient [m]"
* reaction.onset -> "reaction.reaction [m]"