...
* valueQuantity -> "2120: target not supported" "auto added because of must-support"
* valueCodeableConcept -> "2121: target not supported" "auto added because of must-support"
* valueString -> "2122: target not supported" "auto added because of must-support"
...
* identifier.system -> "1476-1: fixed value = http://va.gov/identifiers/$Sta3n/63.05" "generated from mapParameter row 1"
...
* code.coding.system -> "1480-1: fixed value = http://loinc.org if Not NULL" "generated from mapParameter row 1"
...
Mapping: sda-to-LabObservationMicrobiologyMycobacteriologyObservation
Id: sda
