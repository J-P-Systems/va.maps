...
* vaccineCode.text -> "1878: source value based on ADERS - 17_Vac1_TypeBrand" "coding.display not really makes sense, since there is no code"
* route.text -> "1879: source value based on ADERS - 17_Vac1_Route"
* manufacturer.display -> "1883: source value based on ADERS - 17_Vac1_Mfgr"
* lotNumber -> "1884: source value based on ADERS - 17_Vac1_Lot"
* site -> "1885: source value based on ADERS - 17_Vac1_Site"
* protocolApplied.doseNumberString -> "1886: source value based on ADERS - 17_Vac1_DoseInSeries"
