...
Description: "If (undefined) is == ‘Y’ then fixed value STOMA COMPLICATIONS"
Severity: #warning
...
Description: "If (undefined) is == ‘Y’ then fixed value MYOCARDIAL INFARCTION"
Severity: #warning
...
* complication.text -> "1296-1: fixed value = STOMA COMPLICATIONS if == ‘Y’" "mapParameter row 1"
...
* complication.text -> "1297-1: fixed value = MYOCARDIAL INFARCTION if == ‘Y’" "mapParameter row 1"
* performer[va-0].actor -> "1298: reference based on SURGERY - PERFUSIONIST (130-.167)"
* performer[va-0].function.text -> "1298-1: fixed value = PERFUSIONIST" "mapParameter row 1"
* performer[va-0].function.coding -> "1298-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/130#.167 \"PERFUSIONIST\"" "mapParameter row 2"
...
* performer[va-1].function.text -> "1330-1: fixed value = PRIMARY SURGEON" "mapParameter row 1"
* performer[va-1].function.coding -> "1330-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/130#.14 \"PRIMARY SURGEON\"" "mapParameter row 2"
* performer[va-2].actor -> "1331: reference based on SURGERY - FIRST ASST (130-.15)"
* performer[va-2].function.text -> "1331-1: fixed value = FIRST ASST" "mapParameter row 1"
* performer[va-2].function.coding -> "1331-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/130#.15 \"FIRST ASST\"" "mapParameter row 2"
* performer[va-3].actor -> "1332: reference based on SURGERY - SECOND ASST (130-.16)"
* performer[va-3].function.text -> "1332-1: fixed value = SECOND ASST" "mapParameter row 1"
* performer[va-3].function.coding -> "1332-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/130#.16 \"SECOND ASST\"" "mapParameter row 2"
* performer[va-4].actor -> "1333: reference based on SURGERY - ATTENDING SURGEON (130-.164)"
* performer[va-4].function.text -> "1333-1: fixed value = ATTENDING SURGEON" "mapParameter row 1"
* performer[va-4].function.coding -> "1333-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/130#.164 \"ATTENDING SURGEON\"" "mapParameter row 2"
* performer[va-5].actor -> "1334: reference based on SURGERY - ASST PERFUSIONIST (130-.168)"
* performer[va-5].function.text -> "1334-1: fixed value = ASST PERFUSIONIST" "mapParameter row 1"
* performer[va-5].function.coding -> "1334-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/130#.168 \"ASST PERFUSIONIST\"" "mapParameter row 2"
* performer[va-6].actor -> "1335: reference based on SURGERY - SKIN PREPPED BY (1) (130-.18)"
* performer[va-6].function.text -> "1335-1: fixed value = SKIN PREPPED BY (1)" "mapParameter row 1"
* performer[va-6].function.coding -> "1335-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/130#.18 \"SKIN PREPPED BY (1)\"" "mapParameter row 2"
* performer[va-7].actor -> "1336: reference based on SURGERY - PRINC ANESTHETIST (130-.31)"
* performer[va-7].function.text -> "1336-1: fixed value = PRINC ANESTHETIST" "mapParameter row 1"
* performer[va-7].function.coding -> "1336-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/130#.31 \"PRINC ANESTHETIST\"" "mapParameter row 2"
* performer[va-8].actor -> "1337: reference based on SURGERY - RELIEF ANESTHETIST (130-.32)"
* performer[va-8].function.text -> "1337-1: fixed value = RELIEF ANESTHETIST" "mapParameter row 1"
* performer[va-8].function.coding -> "1337-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/130#.32 \"RELIEF ANESTHETIST\"" "mapParameter row 2"
* performer[va-9].actor -> "1338: reference based on SURGERY - ASST ANESTHETIST (130-.33)"
* performer[va-9].function.text -> "1338-1: fixed value = ASST ANESTHETIST" "mapParameter row 1"
* performer[va-9].function.coding -> "1338-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/130#.33 \"ASST ANESTHETIST\"" "mapParameter row 2"
* performer[va-10].actor -> "1339: reference based on SURGERY - ANESTHESIOLOGIST SUPVR (130-.34)"
* performer[va-10].function.text -> "1339-1: fixed value = ANESTHESIOLOGIST SUPVR" "mapParameter row 1"
* performer[va-10].function.coding -> "1339-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/130#.34 \"ANESTHESIOLOGIST SUPVR\"" "mapParameter row 2"
* performer[va-11].actor -> "1340: reference based on SURGERY - VERIFIER (130-.522)"
* performer[va-11].function.text -> "1340-1: fixed value = VERIFIER" "mapParameter row 1"
* performer[va-11].function.coding -> "1340-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/130#.522 \"VERIFIER\"" "mapParameter row 2"
* performer[va-12].actor -> "1341: reference based on SURGERY - PROVIDER (130-123)"
* performer[va-12].function.text -> "1341-1: fixed value = PROVIDER" "mapParameter row 1"
* performer[va-12].function.coding -> "1341-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/130#123 \"PROVIDER\"" "mapParameter row 2"
* performer[va-13].actor -> "1342: reference based on SURGERY - FOLEY CATHETER INSERTED BY (130-.57)"
* performer[va-13].function.text -> "1342-1: fixed value = FOLEY CATHETER INSERTED BY" "mapParameter row 1"
* performer[va-13].function.coding -> "1342-2: fixed value = http://va.gov/terminology/vistaDefinedTerms/130#.57 \"FOLEY CATHETER INSERTED BY\"" "mapParameter row 2"
...
* code.coding.code -> "1344-1: source value based on SURGERY - PLANNED PRIN PROCEDURE CODE > CPT - CPT CODE (130-27 > 81-.01)" "mapParameter row 1"
* code.coding.system -> "1344-2: fixed value = http://www.ama-assn.org/go/cpt" "mapParameter row 2"
* code.coding.display -> "1344-3: source value based on SURGERY - PLANNED PRIN PROCEDURE CODE > CPT - SHORT NAME (130-27 > 81-2)" "mapParameter row 3"
