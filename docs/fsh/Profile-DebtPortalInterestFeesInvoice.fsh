...
* lineItem.priceComponent[va-interest-charged].amount -> "2001: source value from AR TRANSACTION - INT.CHARGE (433-25)"
...
* lineItem.priceComponent[va-admin-charged].amount -> "2002: source value from AR TRANSACTION - ADM.CHARGE (433-25)"
...
* lineItem.priceComponent[va-interest-charged].amount -> "IB.ARTransaction.MarshalFee"
* lineItem.priceComponent[va-admin-charged].amount -> "IB.ARTransaction.MarshalFee"