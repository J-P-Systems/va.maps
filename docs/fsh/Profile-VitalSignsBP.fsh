...
* component[systolic].valueQuantity.value -> "Observation.ObservationValue,Observation.ObservationExtension.BMI"
* component[diastolic].valueQuantity.value -> "Observation.ObservationValue,Observation.ObservationExtension.BMI"
* performer -> "Observation.EnteredAt,Observation.ObservationExtension.Location"
* status -> "Observation.ObservationExtension.Removed"
* status -> "Observation.ObservationExtension.Removed"
* effectiveDateTime -> "Observation.Observation.Description,Observation.ObservationMethod.Description"
* code.coding -> "Observation.ObservationCode,Observation.ObservationExtension.BMI"
...
* valueQuantity.value -> "Observation.ObservationValue,Observation.ObservationExtension.BMI"
* valueQuantity.code -> "Observation.ObservationCode,Observation.ObservationExtension.BMI"