...
* ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/structuredefinition-compliesWithProfile"
* ^extension[=].valueCanonical = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-blood-pressure|7.0.0"
...
* component[systolic].valueQuantity.unit -> "666-2: fixed value = mm[Hg] if VUID = 4500634" "generated from mapParameter row 2"
* component[systolic].code -> "666-3: fixed value = http://loinc.org#8480-6 if VUID = 4500634" "generated from mapParameter row 3"
...
* component[diastolic].valueQuantity.unit -> "667-2: fixed value = mm[Hg] if VUID = 4500634" "generated from mapParameter row 2"
* component[diastolic].code -> "667-3: fixed value = http://loinc.org#8462-4 if VUID = 4500634" "generated from mapParameter row 3"
