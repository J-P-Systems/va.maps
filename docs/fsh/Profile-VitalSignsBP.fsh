...
* component[va-cuff-size].code -> "1805-1: fixed value = http://loinc.org#8358-4 \"Blood pressure device cuff size\"" "mapParameter row 1"
...
* component[systolic].valueQuantity.code -> "666-1: fixed value = mm[Hg] if VUID = 4500634" "mapParameter row 1"
* component[systolic].code.coding.system -> "666-2: fixed value = http://loinc.org if VUID = 4500634" "mapParameter row 2"
* component[systolic].code.coding.code -> "666-3: fixed value = 8480-6 if VUID = 4500634" "mapParameter row 3"
...
* component[diastolic].valueQuantity.code -> "667-1: fixed value = mm[Hg] if VUID = 4500634" "mapParameter row 1"
* component[diastolic].code.coding.system -> "667-2: fixed value = http://loinc.org if VUID = 4500634" "mapParameter row 2"
* component[diastolic].code.coding.code -> "667-3: fixed value = 8462-4 if VUID = 4500634" "mapParameter row 3"
...
Source: VitalSignsBP
* component[va-cuff-size].valueCodeableConcept.coding -> "Observation.ObservationMethods"
* component[systolic].valueQuantity.value -> "Observation.ObservationValue,Observation.Extension[ObservationExtension].BMI"
* component[diastolic].valueQuantity.value -> "Observation.ObservationValue,Observation.Extension[ObservationExtension].BMI"
