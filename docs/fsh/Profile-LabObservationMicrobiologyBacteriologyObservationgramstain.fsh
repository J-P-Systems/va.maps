...
* valueQuantity -> "2096: target not supported" "auto added because of must-support"
* valueCodeableConcept -> "2097: target not supported" "auto added because of must-support"
