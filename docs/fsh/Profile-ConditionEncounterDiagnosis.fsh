...
* identifier.system -> "346-1: fixed value = http://va.gov/identifiers/$Sta3n/9000010.07" "mapParameter row 1"
...
* code.coding.system -> "1613-1: fixed value = urn:see-termmap-in-mapParameter" "mapParameter row 1"
* code.coding.code -> "1613-2: source value based on V POV - POV > ICD DIAGNOSIS - CODE NUMBER (9000010.07-.01 > 80-.01)" "mapParameter row 2"
