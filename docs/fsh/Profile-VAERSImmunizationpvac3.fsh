...
* vaccineCode -> "1934: source value based on ADERS - 22_PVac3_TypeBrand"
* manufacturer.display -> "1935: source value based on ADERS - 22_PVac3_Mfgr"
* lotNumber -> "1936: source value based on ADERS - 22_PVac3_Lot"
* route -> "1937: source value based on ADERS - 22_PVac3_Route"
* site -> "1938: source value based on ADERS - 22_PVac3_Site"
* protocolApplied.doseNumberString -> "1939: source value based on ADERS - 22_PVac3_DoseInSeries"
* occurrenceDateTime -> "1940: source value based on ADERS - 22_PVac3_Date"
