...
* vaccineCode -> "1899: source value based on ADERS - 17_Vac4_TypeBrand"
* manufacturer.display -> "1900: source value based on ADERS - 17_Vac4_Mfgr"
* lotNumber -> "1901: source value based on ADERS - 17_Vac4_Lot"
* route -> "1902: source value based on ADERS - 17_Vac4_Route"
* site -> "1903: source value based on ADERS - 17_Vac4_Site"
* protocolApplied.doseNumberString -> "1904: source value based on ADERS - 17_Vac4_DoseInSeries"
