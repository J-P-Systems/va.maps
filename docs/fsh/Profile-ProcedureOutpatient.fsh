...
* reasonCode.coding.system -> "1302-1: fixed value = urn:see-termmap-in-mapParameter" "generated from mapParameter row 1"
* reasonCode.coding.code -> "1302-2: source value based on V CPT - DIAGNOSIS > ICD DIAGNOSIS - CODE NUMBER (9000010.18-.05 > 80-.01)" "generated from mapParameter row 2"
* reasonCode -> "1303: source value based on V CPT - DIAGNOSIS 2 > ICD DIAGNOSIS (9000010.18-.09 > 80-)"
* reasonCode.coding.system -> "1303-1: fixed value = urn:see-termmap-in-mapParameter" "generated from mapParameter row 1"
* reasonCode.coding.code -> "1303-2: source value based on V CPT - DIAGNOSIS 2 > ICD DIAGNOSIS - CODE NUMBER (9000010.18-.09 > 80-.01)" "generated from mapParameter row 2"
* reasonCode -> "1304: source value based on V CPT - DIAGNOSIS 3 > ICD DIAGNOSIS (9000010.18-.1 > 80-)"
* reasonCode.coding.system -> "1304-1: fixed value = urn:see-termmap-in-mapParameter" "generated from mapParameter row 1"
* reasonCode.coding.code -> "1304-2: source value based on V CPT - DIAGNOSIS 3 > ICD DIAGNOSIS - CODE NUMBER (9000010.18-.1 > 80-.01)" "generated from mapParameter row 2"
* reasonCode -> "1305: source value based on V CPT - DIAGNOSIS 4 > ICD DIAGNOSIS (9000010.18-.11 > 80-)"
* reasonCode.coding.system -> "1305-1: fixed value = urn:see-termmap-in-mapParameter" "generated from mapParameter row 1"
* reasonCode.coding.code -> "1305-2: source value based on V CPT - DIAGNOSIS 4 > ICD DIAGNOSIS - CODE NUMBER (9000010.18-.11 > 80-.01)" "generated from mapParameter row 2"
* reasonCode -> "1306: source value based on V CPT - DIAGNOSIS 5 > ICD DIAGNOSIS (9000010.18-.12 > 80-)"
* reasonCode.coding.system -> "1306-1: fixed value = urn:see-termmap-in-mapParameter" "generated from mapParameter row 1"
* reasonCode.coding.code -> "1306-2: source value based on V CPT - DIAGNOSIS 5 > ICD DIAGNOSIS - CODE NUMBER (9000010.18-.12 > 80-.01)" "generated from mapParameter row 2"
* reasonCode -> "1307: source value based on V CPT - DIAGNOSIS 6 > ICD DIAGNOSIS (9000010.18-.13 > 80-)"
* reasonCode.coding.system -> "1307-1: fixed value = urn:see-termmap-in-mapParameter" "generated from mapParameter row 1"
* reasonCode.coding.code -> "1307-2: source value based on V CPT - DIAGNOSIS 6 > ICD DIAGNOSIS - CODE NUMBER (9000010.18-.13 > 80-.01)" "generated from mapParameter row 2"
* reasonCode -> "1308: source value based on V CPT - DIAGNOSIS 7 > ICD DIAGNOSIS (9000010.18-.14 > 80-)"
* reasonCode.coding.system -> "1308-1: fixed value = urn:see-termmap-in-mapParameter" "generated from mapParameter row 1"
* reasonCode.coding.code -> "1308-2: source value based on V CPT - DIAGNOSIS 7 > ICD DIAGNOSIS - CODE NUMBER (9000010.18-.14 > 80-.01)" "generated from mapParameter row 2"
* reasonCode -> "1309: source value based on V CPT - DIAGNOSIS 8 > ICD DIAGNOSIS (9000010.18-.15 > 80-)"
* reasonCode.coding.system -> "1309-1: fixed value = urn:see-termmap-in-mapParameter" "generated from mapParameter row 1"
* reasonCode.coding.code -> "1309-2: source value based on V CPT - DIAGNOSIS 8 > ICD DIAGNOSIS - CODE NUMBER (9000010.18-.15 > 80-.01)" "generated from mapParameter row 2"
...
* code.coding.code -> "1413-1: source value based on V CPT - CPT > CPT - CPT CODE (9000010.18-.01 > 81-.01)" "generated from mapParameter row 1"
* code.coding.display -> "1413-2: source value based on V CPT - CPT > CPT - SHORT NAME (9000010.18-.01 > 81-2)" "generated from mapParameter row 2"
* code.coding.system -> "1413-3: fixed value = http://www.ama-assn.org/go/cpt" "generated from mapParameter row 3"
