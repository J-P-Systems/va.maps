...
* reasonCode.coding.system -> "1302-1: fixed value = urn:see-termmap-in-mapParameter" "from mapParameter 1"
* reasonCode.coding.code -> "1302-2: source value from V CPT - DIAGNOSIS > ICD DIAGNOSIS - CODE NUMBER (9000010.18-.05 > 80-.01)" "from mapParameter 2"
* reasonCode -> "1303: source value from V CPT - DIAGNOSIS 2 > ICD DIAGNOSIS (9000010.18-.09 > 80-)"
* reasonCode.coding.system -> "1303-1: fixed value = urn:see-termmap-in-mapParameter" "from mapParameter 1"
* reasonCode.coding.code -> "1303-2: source value from V CPT - DIAGNOSIS 2 > ICD DIAGNOSIS - CODE NUMBER (9000010.18-.09 > 80-.01)" "from mapParameter 2"
* reasonCode -> "1304: source value from V CPT - DIAGNOSIS 3 > ICD DIAGNOSIS (9000010.18-.1 > 80-)"
* reasonCode.coding.system -> "1304-1: fixed value = urn:see-termmap-in-mapParameter" "from mapParameter 1"
* reasonCode.coding.code -> "1304-2: source value from V CPT - DIAGNOSIS 3 > ICD DIAGNOSIS - CODE NUMBER (9000010.18-.1 > 80-.01)" "from mapParameter 2"
* reasonCode -> "1305: source value from V CPT - DIAGNOSIS 4 > ICD DIAGNOSIS (9000010.18-.11 > 80-)"
* reasonCode.coding.system -> "1305-1: fixed value = urn:see-termmap-in-mapParameter" "from mapParameter 1"
* reasonCode.coding.code -> "1305-2: source value from V CPT - DIAGNOSIS 4 > ICD DIAGNOSIS - CODE NUMBER (9000010.18-.11 > 80-.01)" "from mapParameter 2"
* reasonCode -> "1306: source value from V CPT - DIAGNOSIS 5 > ICD DIAGNOSIS (9000010.18-.12 > 80-)"
* reasonCode.coding.system -> "1306-1: fixed value = urn:see-termmap-in-mapParameter" "from mapParameter 1"
* reasonCode.coding.code -> "1306-2: source value from V CPT - DIAGNOSIS 5 > ICD DIAGNOSIS - CODE NUMBER (9000010.18-.12 > 80-.01)" "from mapParameter 2"
* reasonCode -> "1307: source value from V CPT - DIAGNOSIS 6 > ICD DIAGNOSIS (9000010.18-.13 > 80-)"
* reasonCode.coding.system -> "1307-1: fixed value = urn:see-termmap-in-mapParameter" "from mapParameter 1"
* reasonCode.coding.code -> "1307-2: source value from V CPT - DIAGNOSIS 6 > ICD DIAGNOSIS - CODE NUMBER (9000010.18-.13 > 80-.01)" "from mapParameter 2"
* reasonCode -> "1308: source value from V CPT - DIAGNOSIS 7 > ICD DIAGNOSIS (9000010.18-.14 > 80-)"
* reasonCode.coding.system -> "1308-1: fixed value = urn:see-termmap-in-mapParameter" "from mapParameter 1"
* reasonCode.coding.code -> "1308-2: source value from V CPT - DIAGNOSIS 7 > ICD DIAGNOSIS - CODE NUMBER (9000010.18-.14 > 80-.01)" "from mapParameter 2"
...
* code.coding.system -> "1413-3: fixed value = http://www.ama-assn.org/go/cpt" "from mapParameter 3"
