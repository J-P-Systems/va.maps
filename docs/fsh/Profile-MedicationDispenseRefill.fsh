...
Source: MedicationDispenseRefill
* destination.display -> "pharmacy.currentProvider,pharmacy.fill [m],pharmacy.fillsRemaining"
* authorizingPrescription -> "pharmacy.id,pharmacy.orderID,pharmacy.parent"
* daysSupply -> "pharmacy.currentProvider,pharmacy.fill [m],pharmacy.fillsRemaining"
* destination.display -> "pharmacy.currentProvider,pharmacy.fill [m],pharmacy.fillsRemaining"
* dosageInstruction.doseAndRate.doseQuantity.unit -> "pharmacy.dose [m]"
* dosageInstruction.doseAndRate.doseQuantity.code -> "pharmacy.dose [m]"
...
* quantity.value -> "pharmacy.currentProvider,pharmacy.fill [m],pharmacy.fillsRemaining"
* status -> "pharmacy.currentProvider,pharmacy.fill [m],pharmacy.fillsRemaining"
* status -> "pharmacy.currentProvider,pharmacy.fill [m],pharmacy.fillsRemaining"
* whenPrepared -> "pharmacy.currentProvider,pharmacy.fill [m],pharmacy.fillsRemaining"
* location -> "pharmacy.currentProvider,pharmacy.fill [m],pharmacy.fillsRemaining"
* note.text -> "pharmacy.currentProvider,pharmacy.fill [m],pharmacy.fillsRemaining"
* performer.actor -> "pharmacy.currentProvider,pharmacy.fill [m],pharmacy.fillsRemaining"