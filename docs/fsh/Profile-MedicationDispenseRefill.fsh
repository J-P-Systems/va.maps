...
* quantity.value -> "pharmacy (med).fill [m],med.fill [m]"
* status -> "pharmacy (med).fill [m],med.fill [m]"
* status -> "pharmacy (med).fill [m],med.fill [m]"
* subject -> "pharmacy (med).units,med.units"
* whenPrepared -> "pharmacy (med).fill [m],med.fill [m]"
* location -> "pharmacy (med).fill [m],med.fill [m]"
* note.text -> "pharmacy (med).fill [m],med.fill [m]"
* performer.actor -> "pharmacy (med).fill [m],med.fill [m]"