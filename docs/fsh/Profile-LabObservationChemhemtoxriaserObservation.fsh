...
* identifier.system -> "851-1: fixed value = http://va.gov/identifiers/$Sta3n/63.04" "generated from mapParameter row 1"
...
* code.coding.system -> "853-1: fixed value = http://loinc.org" "generated from mapParameter row 1"
* code.coding.code -> "853-2: source value based on CHEM, HEM, TOX, RIA, SER, etc. - ORDERED TEST > ORDERED TEST - LAB TEST ORDERED > LABORATORY TEST - SITE/SPECIMEN > SITE/SPECIMEN - LOINC CODE > LAB LOINC - CODE (63.04-.35 > 63.07-13 > 60-100 > 60.01-95.3 > 95.3-.01)" "generated from mapParameter row 2"
* code.coding.display -> "853-3: source value based on CHEM, HEM, TOX, RIA, SER, etc. - ORDERED TEST > ORDERED TEST - LAB TEST ORDERED > LABORATORY TEST - SITE/SPECIMEN > SITE/SPECIMEN - LOINC CODE > LAB LOINC - COMPONENT (63.04-.35 > 63.07-13 > 60-100 > 60.01-95.3 > 95.3-1)" "generated from mapParameter row 3"
