...
* outcome.coding contains va-outcome1 0..1 and va-outcome2 0..1 and va-outcome3 0..1 and va-outcome8 0..1 and va-outcome9 0..1 and va-outcome10 0..1 and va-outcome11 0..1 and va-outcome12 0..1
* subject and actuality and date and event.coding and outcome.coding[va-outcome1] and outcome.coding[va-outcome2] and outcome.coding[va-outcome3] and outcome.coding[va-outcome8] and outcome.coding[va-outcome9] and outcome.coding[va-outcome10] and outcome.coding[va-outcome11] and outcome.coding[va-outcome12] and suspectEntity.instance MS
