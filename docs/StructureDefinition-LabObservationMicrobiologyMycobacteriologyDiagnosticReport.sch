...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DiagnosticReport">
      <sch:assert test="count(f:extension[@url = 'http://va.gov/fhir/StructureDefinition/extension-DiagnosticReport-note']) &lt;= 1">extension with URL = 'http://va.gov/fhir/StructureDefinition/extension-DiagnosticReport-note': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
